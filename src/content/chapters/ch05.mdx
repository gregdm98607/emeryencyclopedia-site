...
<FigureImage
  src="/images/chapters/ch05_opensource_cryptobiotic_crust.jpg"
  alt="Close-up of biological soil crust on desert soil, showing dark lumpy cyanobacteria and lichen colonies"
  caption="Figure 5.2. Biological soil crust near Butler Wash Ruins in southeast Utah — the living black carpet of cyanobacteria, fungi, mosses, and lichens that colonizes desert soils across the Colorado Plateau. In Emery County's arid climate, a single footstep can crush decades of growth; full recovery takes 50 to 250 years."
  credit="Steven Baltakatei Sandoval / CC BY-SA 4.0 via Wikimedia Commons"
/>
...
<FigureImage
  src="/images/chapters/ch05_opensource_sagebrush_steppe.jpg"
  alt="Basin big sagebrush steppe landscape in Utah showing grey-green shrubs across open flat terrain"
  caption="Figure 5.3. Basin big sagebrush (*Artemisia tridentata tridentata*) steppe in Utah — the grey-green sea that dominates mid-elevation benches across Emery County between roughly 4,500 and 6,500 feet. Sagebrush provides essential winter forage and cover for mule deer, pronghorn, and sage grouse, and its silver-blue colour defines the visual character of the San Rafael River bench country."
  credit="Matt Lavin / CC BY-SA 2.0 via Wikimedia Commons"
/>
...
<FigureImage
  src="/images/chapters/ch05_opensource_alpine_meadow_fishlake.jpg"
  alt="Subalpine riparian meadow along the Fremont River in Fishlake National Forest, showing green grasses and scattered conifers at high elevation"
  caption="Figure 5.5. Zedd's Meadow along the upper Fremont River in Fishlake National Forest, central Utah — a subalpine riparian meadow at roughly 8,500 feet. The same high-elevation grassland and meadow communities carpet the tops of the Wasatch Plateau on Emery County's western rim, sustaining elk, black bear, and summer wildflower blooms from July through September."
  credit="USDA Forest Service — Intermountain Region / Public Domain"
/>

<DataTable
  caption="Table 5-A — Vegetation Zones Summary"
  note="Source: §5.1–5.7 (Welsh et al., A Utah Flora, 2003)."
  id="table-5-a"
>

| Zone | Elevation | Dominant species |
|---|---|---|
| Salt-desert shrubland | < ~4,500 ft | shadscale, greasewood, fourwing saltbush |
| Sagebrush steppe | ~4,500–6,000 ft | basin/Wyoming big sagebrush, Indian ricegrass |
| Pinyon–juniper woodland | ~5,500–7,500 ft | two-needle pinyon, Utah juniper |
| Mountain brush | ~7,000–9,000 ft | Gambel oak, serviceberry, mountain mahogany |
| Ponderosa / mixed montane | ~7,500–9,000 ft | ponderosa pine, Douglas-fir, white fir |
| Subalpine spruce–fir | > ~9,000 ft | Engelmann spruce, subalpine fir |
| Alpine meadow | > ~10,500 ft | cushion plants, sedges, forbs |

</DataTable>

## 5.8 Riparian Corridors & Wetlands

Emery County's riparian corridors thread lush vegetation through its predominantly arid landscapes, clustering along perennial streams — most notably the Green, San Rafael, and Price rivers — and at spring-fed seeps (see <CrossRef chapter={3} />). Dominant canopy species include Fremont cottonwood (*Populus fremontii*), narrowleaf willow (*Salix exigua*), and box elder (*Acer negundo*), forming gallery forests that stabilize banks and moderate water temperatures. Understory layers of sedges (*Carex* spp.), rushes (*Juncus* spp.), and native grasses thrive in seasonally saturated soils, while downstream reaches host emergent marshes dominated by cattails (*Typha latifolia*) and bulrushes (*Schoenoplectus* spp.). Beavers (*Castor canadensis*) play a keystone role: their dams raise water tables, expand wetland mosaics, and enhance habitat complexity for amphibians and riparian birds (Stevens & Meretsky 2008). Hyporheic exchange zones — where surface water infiltrates channel gravels — sustain baseflows and maintain water quality during dry spells.
...
Emery County harbors a remarkable assemblage of rare, endemic, and relict plant species that testify to its unique geology and microclimates (see <CrossRef chapter={30} />). The San Rafael cactus (*Pediocactus despainii*), confined to calcic outcrops within the San Rafael Swell, produces vibrant magenta blooms in spring and is listed as endangered under the federal Endangered Species Act (U.S. Fish & Wildlife Service 2010). Wright's fishhook cactus (*Sclerocactus wrightiae*) thrives on sandy terraces along the Green River, its hooked spines nearly camouflaged against the pale substrate. The Cisco milkvetch (*Astragalus despainii*) is restricted to Mancos Shale benches in the county, adapted to thin, seasonally saturated soils. Alpine relicts such as *Polemonium pulcherrimum* persist in snowdrift hollows above 10,000 feet — Pleistocene survivors in cool refugia that have persisted as the climate warmed around them. Additional special-status taxa include *Frankenia jamesii* and *Astragalus coccineus*, each tied to saline or gypsum-rich seeps. Population counts for *Pediocactus despainii* number in the hundreds of known individuals, and specialized habitat needs make these species highly vulnerable to grazing, road dust, and climate shifts. Conservation measures by the Utah Natural Heritage Program and BLM include population monitoring, seed banking, and invasive saltcedar removal to protect spring habitats.

<DataTable
  caption="Table 5-B — Rare, Endemic & Relict Plants (Selected)"
  note="Source: §5.9 (Utah Natural Heritage Program 2022; USFWS recovery plans). Populations often < 500 plants; precise localities protected."
  id="table-5-b"
>

| Species | Habitat | Elevation / substrate |
|---|---|---|
| San Rafael cactus (*Pediocactus despainii*) | San Rafael Swell calcic outcrops | Cedar Mesa Sandstone |
| Wright's fishhook cactus (*Sclerocactus wrightiae*) | sandy terraces along the Green River | low desert |
| Cisco milkvetch (*Astragalus despainii*) | Mancos Shale benches near Cisco | thin seasonally-saturated soils |
| *Polemonium pulcherrimum* (alpine relict) | snow-drift hollows | > 10,000 ft |

</DataTable>

<FigureImage
  src="/images/chapters/ch05_opensource_san_rafael_cactus.jpg"
  alt="San Rafael cactus (Pediocactus despainii), a small spiny cactus growing among rocks in desert terrain in Emery and Wayne counties, Utah"
  caption="Figure 5.6. The San Rafael cactus (*Pediocactus despainii*) in its natural pinyon-juniper and desert shrub habitat in Emery and Wayne counties, Utah — the only cactus species endemic to these two counties. Listed as federally endangered in 1987, *P. despainii* grows on calcic sandstone and limestone outcrops at about 6,000 feet elevation in the heart of the San Rafael Swell."
  credit="Daniela Roth / U.S. Fish and Wildlife Service / CC BY 2.0 via Wikimedia Commons"
/>
...
<PhotoAssignment
  ...
  where="San Rafael Swell, Emery County — consult the Utah Natural Heritage Program or BLM Price Field Office (435-636-3600) for current bloom-season access guidance; specific site coordinates are managed to reduce collection pressure on this endangered species"
...
<DataTable
  caption="Table 5-C — Seasonal Wildflower Calendar"
  note="Source: §5.10 (Utah Native Plant Society; iNaturalist phenology 2010–2024). First-bloom dates have advanced ~5–7 days over three decades."
  id="table-5-c"
>

| Window | Elevation | Indicator blooms |
|---|---|---|
| April–May | < 5,000 ft | desert paintbrush, sand violet |
| June | 5,000–7,000 ft | Indian paintbrush, silvery lupine, desert marigold |
| July | 7,000–9,000 ft | blazing star, Colorado columbine |
| August | > 9,000 ft | Degener's penstemon, alpine phlox |
...
- Welsh, S.L., Atwood, N.D., Goodrich, S., and Higgins, L.C. *A Utah Flora*, 4th ed. Provo, UT: Brigham Young University Press, 2003.
- USDA NRCS, *Soil Survey of Emery County Area, Utah*.
- Utah Natural Heritage Program — Rare Plant List (2022).
- [Utah Native Plant Society — Utah Rare Plant Guide](https://utahrareplants.org) — Species accounts and conservation status.
- BLM Emery County Springs & Riparian Inventory.
...
14. USDA NRCS, Utah Snow Survey. *SNOTEL Network — Wasatch Plateau Stations.* snotel.wcc.nrcs.usda.gov.
15. USDA Plants Database. *National Plant Data Team.* Greensboro, NC: USDA NRCS. plants.usda.gov.
