...
<DataTable
  caption="Table 2-A — Master Formation Table, Emery County"
  note="Source: Hintze & Kowallis (2009); Doelling (2004); USGS geologic units, Emery County; Peterson et al. (2017)."
  id="table-2-a"
>

| Period (age) | Formation / group | Depositional environment | Economic / scientific note |
|---|---|---|---|
| Pennsylvanian (323–299 Ma) | Hermosa Gp: Paradox, Honaker Trail | Restricted marine basin; open marine | Salt, potash, oil/gas source |
| Permian (299–252 Ma) | Cutler Gp; White Rim/Coconino Ss; Kaibab Ls | Coastal → eolian dune field → marine | Core of San Rafael Swell |
| Triassic (252–201 Ma) | Moenkopi; Chinle (Shinarump Mbr) | Tidal flat; braided rivers, lakes | Uranium host (Shinarump); petrified wood |
| Jurassic (201–145 Ma) | Glen Canyon Gp (Wingate, Kayenta, Navajo); San Rafael Gp (Carmel, Entrada, Curtis, Summerville); Morrison | Ergs/dunes; sabkha; alluvial plain | Iconic cliffs; Cleveland-Lloyd Quarry (Morrison) |
| Cretaceous (145–66 Ma) | Cedar Mountain; Dakota; Mancos Shale (Ferron, Emery mbrs); Mesaverde Gp (Star Point, Blackhawk, Castlegate, Price River) | Rivers/lakes; advancing then retreating Western Interior Seaway; delta swamps | Coal (Blackhawk); Ferron reservoir analog |
| Paleogene–Neogene (66–2.6 Ma) | North Horn; Flagstaff Ls; Colton/Wasatch; Green River | Draining seaway; freshwater lakes; fluvial | Oil shale (Green River); laccolithic Cu |
| Quaternary (2.6 Ma–present) | Alluvium, landslide & glacial deposits | Mass wasting, alluvial reworking, aeolian | Fertile bottomlands; active hazards |
...
Whatever its cause, the uplift had profound consequences for Emery County. As the plateau rose, stream gradients steepened, and rivers that had previously meandered across low-relief surfaces began cutting vigorously downward (see <CrossRef chapter={3} />). The San Rafael River and its tributaries incised the spectacular slot canyons of the Swell — Little Wild Horse, Bell, and Ding-Dang canyons — following joint sets in the Navajo and Entrada sandstones (see <CrossRef chapter={30} />). The Green River, an antecedent stream that predated the uplift, maintained its course by cutting Desolation and Gray canyons through rising strata. The result is the deeply dissected, canyon-laced landscape that defines Emery County today.
...
A fuller treatment of mining history and its social and economic impacts appears in Chapter 17: Coal, Copper & Uranium (see <CrossRef chapter={17} />).

<DataTable
  caption="Table 2-B — Economic Mineral Resources by Host Formation"
  note="Source: chapter §2.11; USGS Bulletin 1239; Kerr & Kidwell (1991)."
  id="table-2-b"
>

| Resource | Host formation (period) | Setting |
|---|---|---|
| Coal | Blackhawk Fm, Mesaverde Gp (Late Cretaceous) | Delta-plain and back-barrier coal swamps |
| Uranium | Shinarump Mbr, Chinle Fm (Late Triassic); Salt Wash Mbr, Morrison Fm (Late Jurassic) | Roll-front mineralization in fluvial sandstone |
| Oil & gas | Paradox Fm (Pennsylvanian); Ferron Ss (Cretaceous); Swell structural traps | Source rock; reservoir; anticline traps |
| Oil shale | Green River Fm (Eocene) | Lacustrine kerogen (never commercially extracted in-county) |
| Copper / metallics | Oligocene–Miocene laccolithic intrusions | Contact-mineralized country rock |
...
<DataTable
  caption="Table 2-C — Geologic Hazards by Formation and Area"
  note="Source: chapter §2.12; UGS Survey Notes."
  id="table-2-c"
>

| Hazard | Source formation(s) | Where |
|---|---|---|
| Landslides | North Horn Fm, Mancos Shale | Wasatch Plateau; SR-31 Huntington Canyon, SR-29 Joes Valley |
| Flash floods | Mancos Shale badlands; Navajo/Entrada slot canyons | Little Wild Horse, Crack Canyon (monsoon season) |
| Expansive soils | Mancos Shale, Chinle Fm | County lowlands |
| Radon gas | Chinle & Morrison fms (uranium decay) | Communities near the San Rafael Swell |
...
- [USGS Mineral Resources — Geologic Units in Emery County](https://mrdata.usgs.gov/geology/state/fips-unit.php?code=f49015) — Searchable formation catalog for the county.
- [Utah Geological Survey — Geologic Maps & Survey Notes](https://geology.utah.gov) — UGS Map 193 (San Rafael Swell) and landslide/lake articles.
- Peterson, J.E. et al. "New Data towards the Development of a Comprehensive Taphonomic Framework for the Late Jurassic Cleveland-Lloyd Dinosaur Quarry, Central Utah." *PeerJ* 5:e3368 (2017). [https://doi.org/10.7717/peerj.3368](https://doi.org/10.7717/peerj.3368) — open-access primary source.
- [Jurassic National Monument / Cleveland-Lloyd Dinosaur Quarry (BLM)](https://www.blm.gov/visit/cleveland-lloyd-dinosaur-quarry) — Visitor and interpretive information.
