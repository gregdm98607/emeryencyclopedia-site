...
<FigureImage
  src="/images/chapters/ch26_figure_cultural-timeline.png"
  alt="Timeline of arts, literature, and media in Emery County, 1895-2023"
  caption="Figure 26-A. Arts, literature, and media in Emery County, 1895-2023. Color indicates domain. The pioneer dance and oral-tradition era predates the chart's range and carries no firm date in the sources."
  credit="Source: Chapter 26 body and cited sources therein"
/>

When coal mining took hold in the late 1880s and 1890s (see <CrossRef chapter={17} />), it brought a second wave of newcomers whose cultural inheritance was not Sanpete-Mormon but Welsh, English-northern, Greek, Italian, Serbian, Croatian, Finnish, and Japanese. Their music transformed Castle Country.
...
- *A History of Water Development in Emery County, Utah*, a longer water-focused study informing the Emery Water Conservancy District's institutional memory (see <CrossRef chapter={19} />).
...
<DataTable
  caption="Table 26-C — Selected Works by or about Emery County"
  note="Source: Chapter 26 §26.4, §26.5, §26.8 and the chapter Sources list. Publication year for the water-development study is not given in the chapter and is not estimated."
  id="table-26-c"
>

| Work | Author | Publisher / venue | Year | Subject |
|---|---|---|---|---|
| *Castle Valley: A History of Emery County* | Stella McElprang, comp. | Daughters of Utah Pioneers, Emery County Camps | 1949 | Compiled reminiscences, ward histories, biographical sketches; 343 pp. |
| *A History of Emery County* | Edward A. Geary | Utah Historical Society, Utah Centennial County History Series | 1981 | Standard analytical one-volume county history |
| *Goodbye to Poplarhaven: Recollections of a Utah Boyhood* | Edward A. Geary | University of Utah Press | 1985 | Memoir of 1940s–50s Huntington; AML memoir prize 1986 |
| "History Written on the Land in Emery County" | Edward A. Geary | *Utah Historical Quarterly* 66 (Summer 1998): 196–224 | 1998 | Landscape history — reading settlement in roads, fences, ditches |
| *A History of Water Development in Emery County, Utah* | Edward A. Geary | Water History project | not stated | Water development; informs Ch19 |
| Castle Valley Pageant script | Edwin Montell Seely | Unpublished / community production | 1978 | Five Sanpete families under the 1877 colonizing call |

</DataTable>

<FigureImage
  src="/images/chapters/ch26_figure_progress-publication-run.png"
  alt="Gapped span chart of Emery County's newspaper of record publication run, 1891-2026"
  caption="Figure 26-B. Emery County's newspaper of record, 1891-2026: Emery County Pioneer (~1891-1893), Emery County Progress (1900-1963), Emery County Progress-Leader successor-title period (1963-1977), Emery County Progress (1977-2018), and ETV News Progress (2018-present)."
  credit="Source: Library of Congress catalogue records sn85058128, sn84007700, and 2021220991; Utah Digital Newspapers; ETV News"
/>
...
<DataTable
  caption="Table 26-B — Broadcast and Print Media Serving Emery County"
  note="Source: Chapter 26 §26.7 (radio and cable), §26.6 (print). Verification flag: the 1080 AM row is corrected from the chapter's stale 'KASL' to the current KSLL and is the one row here that has been checked. The remaining callsigns, frequencies, and formats are carried unverified from the chapter body and should be confirmed against the FCC licence database before print — the 'Kickin' Country FM (750 AM)' entry in particular."
  id="table-26-b"
>

| Outlet | Frequency / channel | Format | Licensed / based | Owner |
|---|---|---|---|---|
| Kickin' Country | 750 AM and 98.3 FM | Country | Carbon County | not stated |
| KSLL Castle Country (formerly KASL) | 1080 AM | Country | Price (Carbon County) | Ajb Holdings, LLC |
| KUSA "The Eagle" | 100.9 FM | not stated | Carbon County | not stated |
| ETV Channel 26 | Cable channel 26 | Local television | Emery County | Emery Telcom |
| *ETV News Progress* | weekly print + etvnews.com | Newspaper | Orangeville | Emery Telcom |
...
<DataTable
  caption="Table 26-A — Castle Country Museums at a Glance"
  note="Annual visitation figures were not available in any cited source and are omitted rather than estimated. Admission and governance are left blank where the sources are silent. Source: Utah Division of Arts & Museums museum directory; National Park Service; Visit Emery County."
  id="table-26-a"
>

| Museum | Location | County | Primary collection | Governance | Admission |
|---|---|---|---|---|---|
| Museum of the San Rafael | 70 N 100 E, Castle Dale | Emery | Paleontology and archaeology: Allosaurus and Camptosaurus skeletons, dinosaur-egg replicas, regional-fauna dioramas, Fremont corpus, the Sitterud Bundle (c. 1250 CE) | Operated by Emery County | Free |
| Emery County Pioneer Museum | 64 E 100 N, Castle Dale | Emery | 19th-century interiors: mercantile, lawyer's office, one-room schoolroom, pioneer home; farming, ranching and mining tools; rotating local-artist gallery | Volunteer — DUP and Emery County Historical Society | not stated |
| John Wesley Powell River History Museum | Green River | Green River corporate limits; partly Grand County by topographic technicality | Powell's 1869 and 1871 Green River expeditions; Green River as steamboat, ferry and rail town | not stated | not stated |
| USU Eastern Prehistoric Museum | 155 E Main Street, Price | Carbon | 750,000+ paleontological and archaeological specimens; Don L. Burge Day; "The Other Side of Utah" (annual since 2006); Castle Country Community Art Show | Utah State University Eastern | not stated |
...
**The John Wesley Powell River History Museum** (Green River) is a regional museum with anchoring exhibits on Powell's 1869 and 1871 Green River expeditions (see <CrossRef chapter={15} />) and on Green River's history as a steamboat, ferry, and rail town. It is partially in Grand County by topographic technicality but located within the Green River corporate limits and is generally treated as an Emery County asset.
...
- [Library of Congress — Emery County Progress catalogue records](https://www.loc.gov/item/sn85058128)
- [Utah Division of Arts & Museums — Museum Directory](https://artsandmuseums.utah.gov/utah-museums-directory/)
- [University of Utah Press — Goodbye to Poplarhaven](https://uofupress.lib.utah.edu/goodbye-to-poplarhaven/)
- [Edward A. Geary — History Written on the Land in Emery County, Utah Historical Quarterly 66 (1998)](https://issuu.com/utah10/docs/uhq_volume66_1998_number3)
