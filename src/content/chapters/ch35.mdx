...
The park's geological setting amplifies the night-sky experience. The thousands of hoodoo formations that fill the valley floor — Jurassic Entrada Sandstone weathered into mushroom-shaped pillars (see <CrossRef chapter={2} />) — provide an extraordinary foreground for astrophotography. A photograph of the Milky Way rising over the goblins is one of the signature images of southern Utah astrotourism.
...
The Bortle scale, introduced by amateur astronomer John E. Bortle in a 2001 *Sky & Telescope* article, gives a common vocabulary for describing night-sky darkness (see <CrossRef chapter={7} />). It runs from Class 1 (excellent dark-sky site — pristine; zodiacal light prominent; the Milky Way casts a faint shadow) to Class 9 (inner-city sky — only the Moon, planets, and a handful of the brightest stars visible).
...
<FamilyActivity
  title="Catch the Perseids: A Meteor-Shower Campout"
  ageRange="All ages"
  duration="A few hours (midnight to dawn)"
  description="On the night of August 12–13, drive to a dark Emery County overlook, lie back with a pad and a red headlamp, give your eyes 20 minutes to dark-adapt, and count meteors — a dark Swell sky can deliver 60 to 100 an hour at the Perseid peak."
  materials={["A reclining chair or foam pad and sleeping bag", "A red-light headlamp", "Warm layers (desert nights cool fast)", "Snacks and patience"]}
/>
...
<DataTable
  caption="Table 35-B — Observing Equipment by Experience Level"
  note="Equipment and price figures per §35.6; prices are chapter-date estimates, verify before purchase."
  id="table-35-b"
>

| Level | Core kit | Adds | Approx. entry cost |
|---|---|---|---|
| Beginner | Red-light headlamp; warm layers; reclining chair or pad; free star chart or Stellarium app | Smartphone Night-mode photos | Minimal |
| Intermediate | 7×50 or 10×50 binoculars; printed monthly chart; ISS/satellite pass app | PhotoPills or SkySafari for planning | Low (binoculars) |
| Committed visual | 8-inch Dobsonian (~$500–600 new) or 4-inch refractor; observing stool | 6-inch SCT with Go-To as alternative | ~$500–600 |
| Astrophotography | DSLR/mirrorless + 14–24mm f/2.8 + sturdy tripod | Compact tracker (e.g., Sky-Watcher Star Adventurer); stacking software (Sequator, DeepSkyStacker, StarStaX — free) | Camera-dependent |

</DataTable>

<ScavengerHunt
  title="The Binocular Sky Hunt"
  location="Emery County"
  items={["The band of the Milky Way — a soft, uneven river of light; look south in summer", "The Andromeda Galaxy (M31) — a faint fuzzy oval; the most distant thing your eyes can see unaided", "The Pleiades — a tight little dipper of blue stars in Taurus (best in winter)", "Jupiter's four moons — steady your binoculars on a rail to line up all four Galilean moons", "The Orion Nebula — a misty patch in the 'sword' hanging below Orion's belt (winter)", "A satellite crossing the sky — a steady moving 'star' that never blinks", "The International Space Station — brighter and faster than any satellite; use the ISS Detector app to time it", "A shooting star — patience required"]}
/>
...
**Astrophotography Ethics.** All the wildlife-watching ethics in <CrossRef chapter={34} /> apply at night too. Use red lights; do not park where headlights illuminate other observers' fields of view; do not climb on geological features for "the shot."
...
<DataTable
  caption="Table 35-A — Dark-Sky Hotspots in Emery County"
  note="Bortle estimates per chapter text (site-level SQM measurements not available); access per BLM/Utah State Parks/USFS route descriptions."
  id="table-35-a"
>
...
- Full tank of gas (last fuel: Green River or Hanksville; Castle Dale northbound — see <CrossRef chapter={36} /> for detailed fuel and services logistics)
...
- [DarkSky International — Goblin Valley State Park](https://darksky.org) — the park's IDSP listing and lighting standards.
- [Utah State Parks — Dark Sky Programs & Events](https://stateparks.utah.gov/activities/dark-sky/dark-sky-events) — current ranger-program schedules.
- [National Park Service — Night Skies](https://www.nps.gov/subjects/nightskies) — federal dark-sky science and stewardship hub.
- [Falchi et al., *The New World Atlas of Artificial Night Sky Brightness*](https://www.science.org/doi/10.1126/sciadv.1600377) — the light-pollution atlas §35.9 describes; freely viewable online.
- [NOAA Space Weather Prediction Center](https://www.swpc.noaa.gov) — aurora alerts referenced in §35.5.
- [Salt Lake Astronomical Society](https://slas.us) — Utah's amateur society; public star parties.
