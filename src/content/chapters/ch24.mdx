...
<FigureImage
  src="/images/chapters/ch24_figure_education-timeline.png"
  alt="Timeline of education institutional milestones in Castle Valley, 1877-2010"
  caption="Figure 24-A. Education in Castle Valley: institutional milestones, 1877-2010, from Brigham Young's Castle Valley call through the USU Eastern merger."
  credit="Source: Utah History Encyclopedia; Tabone (1976); Utah State University Eastern; Emery County Archives"
/>

The first families to answer Brigham Young's August 22, 1877 call to settle Castle Valley (see <CrossRef chapter={16} />) arrived to a place with no buildings, no roads, and no books. The 1880 federal census found 237 settlers strung along Cottonwood Creek (Utah History Encyclopedia, 1994). Their first schools were improvised: a corner of a dugout, a log cabin doubling as a church, a parlor donated for the winter term. Itinerant teachers — sometimes a literate older sister, sometimes a young man "called" by the LDS bishop — taught the **McGuffey Eclectic Readers** that travelled west in nearly every Mormon wagon, alongside basic arithmetic, penmanship, and scripture.
...
<DataTable
  caption="Table 24-A — Emery County School District, 2026"
  note="Ten schools, ~2,248 students; HQ Huntington. Source: ECSD 2026 roster; NCES; Niche."
  id="table-24-a"
>
...
| Cleveland Elementary | Cleveland | Elementary (smallest) |
...
| Emery High School | Castle Dale | High (Spartans) |
| Green River High School | Green River | High (Pirates) |
...
<DataTable
  caption="Table 24-B — Higher-Education Lineage Serving Emery County"
  note="Source: USU Eastern history; USU Statewide Campuses. ~40% of USU Eastern students first-generation."
  id="table-24-b"
>

| Year | Event |
|---|---|
| 1937 | Carbon College founded, Price — serves Carbon, Emery, Grand |
| 1959 | Joins the University of Utah system |
| 1965 | Renamed College of Eastern Utah (CEU) |
| 2010 (Jul 1) | Merged into Utah State University as USU Eastern |
| — | USU Castle Dale Education Center — satellite in-county (associate's, certificate, continuing ed) |
...
Beyond the library system, the **county museum and the Museum of the San Rafael** in Castle Dale (see <CrossRef chapter={26} />) operate as quasi-educational institutions, with strong K–12 outreach programs and field-trip curricula tied to county geology, paleontology, and pioneer history.
...
<FigureImage
  src="/images/chapters/ch24_figure_performance-indicators.png"
  alt="Grouped bar chart of Emery School District outcomes versus Utah statewide, 2022-2026"
  caption="Figure 24-B. Emery School District outcomes vs. Utah, 2022-2026: graduation rate (87%, no statewide comparator cited), math proficiency (42% Emery vs. 40% Utah), and reading proficiency (35% Emery vs. 43% Utah)."
  credit="Source: Public School Review (2026); Utah State Board of Education report card"
/>
...
<DataTable
  caption="Table 24-C — District Performance Indicators, 2022-2026"
  note="Source: Public School Review (2026); USBE 2022-23 report card."
  id="table-24-c"
>

| Indicator | Emery County | Utah statewide |
|---|---|---|
| Graduation rate | 87% (down from 90-94%) | not cited |
| Math proficiency (district avg) | 42% | 40% |
| Reading proficiency (district avg) | 35% | 43% |
| — Elementary math / reading | 48% / 34% | — |
| — Middle math / reading | 35% / 31% | — |
| — High math / reading | 42% / 45% | — |
| Overall district ranking | top 50% of Utah's 153 districts | — |
...
Few rural districts in the country face the workforce-transition pressures that Emery does. Chapter 21 details how the closure of coal mines and the projected retirement of the Hunter and Huntington power plants will reshape the regional labor market within a single generation (see <CrossRef chapter={21} />). Schools have been pulled into that transition as both casualty and remedy.
...
2. **Broadband and distance learning.** Rural broadband, accelerated by COVID-era investments and the federal Bipartisan Infrastructure Law funds (see <CrossRef chapter={18} />), is finally delivering reliable connectivity to most of the county. That changes what is possible at the Green River campus, at the Castle Dale center, and in the home of every student.
...
- [Emery County School District](https://www.emeryschools.org/)
- [Utah State Board of Education — Emery District Report Card](https://reportcard.schools.utah.gov/District/Profile?DistrictID=442)
- [Tabone, Paul Robert — The History of the Emery Stake Academy (BYU MA thesis, 1976)](https://scholarsarchive.byu.edu/etd/5159/)
- [Utah State University Eastern](https://eastern.usu.edu/)
- [Public School Review — Emery School District (2026)](https://www.publicschoolreview.com/utah/emery-school-district/4900270-school-district)
