...
Formal agricultural settlement followed in the fall of 1877, when young Latter-day Saint families — responding in part to encouragement from LDS church leadership to occupy unorganized territory before outside interests could claim it — began moving into Castle Valley from Sanpete and other central Utah counties (see <CrossRef chapter={16} />). They established the communities that would become Huntington, Ferron, Castle Dale, and Orangeville, each sited near a reliable stream with land suitable for both farming and grazing. By 1880, when the Utah Territorial Legislature formalized Emery County's existence, the agricultural enterprise was well underway.
...
<DataTable
  caption="Table 20-C — Pioneer irrigation works"
  note="Founding years per ward/county histories; to be verified against LDS ward minute books, Utah State Archives. Source: §20.4."
  id="table-20-c"
>

| Canal | Year begun | Area served |
|---|---|---|
| Pioneer Ditch No. 1 & No. 2 | Among the earliest formal water corporations in Carbon and Emery Counties | Early Castle Valley farmland |
| Ferron North Ditch | 1879 | Ferron townsite, later extended north to Rock Canyon |
| King Ditch | 1879 | Southern Ferron Creek valley |
| Upper South Canal | 1881–82 | Southern Ferron Creek valley |
| Huntington Canal | 1879–1884 (built in stages) | Flats west and south of Huntington |
| Cleveland Canal | Multi-season community project | Cleveland, four miles from nearest water, eleven-plus miles from diversion point |

</DataTable>

All these pioneer canals were built with pick-and-shovel labor and horse-drawn plows and scrapers.
...
The effects on agriculture were significant. More than 90 percent of the irrigated area served by the project produces hay and grain, and the increased water supply permitted expanded livestock production of beef, sheep, and dairy products. The project did not solve the salinization problem — alkali soils remained a challenge wherever drainage was poor — but it stabilized the county's water supply against the year-to-year variability that had made farming so precarious in the preceding decades — the same water system treated in full in <CrossRef chapter={19} />.

<FigureImage
  src="/images/chapters/ch20_figure_agriculture-timeline.png"
  alt="Timeline of agriculture and ranching in Emery County, 1875-2002"
  caption="Figure 20-A. Agriculture & ranching in Emery County, 1875–2002."
  credit="Source: UEN Utah History Encyclopedia; USBR; USDA Census of Agriculture"
/>

<DataTable
  caption="Table 20-A — Emery County Project key statistics"
  note="Source: USBR; EWCD, as cited in §20.6. Reservoir figures here reflect the values as stated in this chapter's sources; see Ch19 §19.6 for Joe's Valley figures as stated there, and the cross-chapter reconciliation note."
  id="table-20-a"
>

| Structure | Stream | Height | Reservoir capacity | Service area |
|---|---|---|---|---|
| Joes Valley Dam / Reservoir | Seely Creek | 187 ft (750-ft crest, 1,290,000 cu yd) | 62,460 acre-feet across 1,170 surface acres | County's principal storage facility |
| Swasey Diversion Dam | Ten miles downstream of Joes Valley | — | — | Channels water into the Cottonwood Creek–Huntington Canal system |
| Huntington North Reservoir / Service Canal | Associated dikes north of Huntington | — | — | Agricultural districts north of Huntington |
| Millsite Reservoir | Ferron Creek, base of Ferron Canyon | — | — | Ferron agricultural district; dedicated 11 June 1971 |
...
<DataTable
  caption="Table 20-B — 2002 USDA agricultural census snapshot"
  note="Source: USDA NASS, as cited in §§20.7, 20.9. The 2022 Census of Agriculture supersedes these figures (~280 farms; ~225,000 acres in production per the chapter's fact-check); reported here as the chapter body states them."
  id="table-20-b"
>
...
|---|---|
| Total farms | 459 |
| Total farmland | ~155,000 acres |
| Irrigated acres | 33,099 |
| Harvested cropland share | 94.2% of irrigated acres |
| Hay acreage | 18,323 acres |
| Barley acreage | 158 acres |
| Total agricultural sales | $11,452,000 |
| Average sales per farm | ~$24,950 |
| Farms with cattle | 281 |
| Farms with horses | 294 |
| Farms with sheep | 45 |
...
The cultural dimension of Green River's melon heritage is formalized each September in Melon Days, a festival that has drawn upward of 4,000 visitors from outside the community. For a city whose population hovers under 1,000, Melon Days represents both an economic event and a community ritual — an annual assertion that Green River's particular combination of river, desert, and human ingenuity produces something genuinely excellent (see <CrossRef chapter={27} /> for the festival and foodways treatment of Melon Days).
...
The arrival of the Denver and Rio Grande Western Railroad through Emery County in 1883 transformed the economics of the livestock industry (see <CrossRef chapter={18} />). Before the railroad, marketing cattle and sheep required long overland drives to distant railheads; after it, livestock could be loaded at local stations and shipped to markets in Denver or Salt Lake City within days. The coal mines developing simultaneously at Scofield, Castle Gate, and Sunnyside in neighboring Carbon County provided an additional local market for beef, pork, and dairy products (see <CrossRef chapter={17} />) — a miner's diet that favored protein-rich foods and created steady demand regardless of distant commodity prices.
...
- [U.S. Bureau of Reclamation — Emery County Project](https://www.usbr.gov/projects/index.php?id=447)
...
- [BLM Price Field Office — Grazing Allotments](https://www.blm.gov/office/price-field-office)
- [Emery County — Agriculture](https://emery.utah.gov/home/department-directory/economic-development/agriculture/)
- [Utah History Encyclopedia — Livestock Industry](https://www.uen.org)
