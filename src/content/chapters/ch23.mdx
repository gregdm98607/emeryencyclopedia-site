...
<FigureImage
  src="/images/chapters/ch23_figure_governance-timeline.png"
  alt="Timeline of Emery County governance milestones, 1880-2019"
  caption="Figure 23-A. Emery County governance milestones, 1880-2019: county creation, boundary splits, special districts, and the Dingell Act."
  credit="Source: Emery County official records; Utah Division of Archives; BLM"
/>
...
The legislature's decision to create Emery County in February 1880 reflected the rapid pace of Mormon colonization in east-central Utah during the preceding decade (see <CrossRef chapter={16} />). Settlements had taken root along Castle Valley's creeks and the Price River drainage; residents needed courts, roads, and county infrastructure that the distant seats of Sevier and Sanpete counties could not efficiently provide.
...
<DataTable
  caption="Table 23-A — Emery County Elected Offices"
  note="Holders intentionally omitted — rosters change with election cycles; §23.3 flags the live commission roster as needing verification. Source: Emery County Department Directory (emery.utah.gov); Utah county-government statute."
  id="table-23-a"
>

| Office | Function | Term |
|---|---|---|
| Board of County Commissioners (3) | Legislative + executive + administrative; budget, levies, ordinances, land use | 4 yr, staggered |
| County Assessor | Values all real/personal property incl. industrial facilities & mineral rights | 4 yr |
| County Clerk/Auditor | Elections, official records, budget process | 4 yr |
| County Recorder | Deeds, liens, ownership records | 4 yr |
| County Treasurer | Tax collection, county funds, tax-roll administration | 4 yr |
| County Sheriff | Law enforcement over unincorporated county; SAR; civil process | 4 yr |
| County Attorney | Criminal prosecution; three court venues | 4 yr |
...
<FigureImage
  src="/images/chapters/ch23_figure_dingell-act-acreage.png"
  alt="Bar chart of Dingell Act acreage by provision in Emery County"
  caption="Figure 23-B. The 2019 Dingell Act in Emery County, by provision: wilderness designated (663,000 ac, four-county total), San Rafael Swell Recreation Area (217,000 ac), state trust land to BLM in the exchange (116,000 ac), and federal land to Trust Lands (98,500 ac)."
  credit="Source: BLM Dingell Act (Utah); BLM-Trust Lands exchange decision; SUWA Emery County summary"
/>

<DataTable
  caption="Table 23-B — Dingell Act Provisions & Acreage (2019)"
  note="Source: BLM Dingell Act (Utah) and BLM-Trust Lands exchange decision; SUWA Emery County summary."
  id="table-23-b"
>

| Provision | Acreage | Note |
|---|---|---|
| Wilderness designated (total) | 663,000 | Across Emery, Carbon, Sanpete & Sevier; largest Western designation in >a decade; Emery share dominant |
| — Muddy Creek unit (largest) | 208,000 | One of 14 new Emery-area units |
| San Rafael Swell Recreation Area | ~217,000 | Withdrawn from new mineral leasing; no new OHV routes; existing OHV use preserved |
| State trust land to BLM (exchange) | 116,000 | >109,000 ac of it in Emery County |
| Federal land to Utah Trust Lands (exchange) | 98,500 | Revenue land for the public-school trust fund |
...
<DataTable
  caption="Table 23-C — Seven County Infrastructure Coalition (2014)"
  note="Source: scic-utah.org."
  id="table-23-c"
>

| Member county | Seat |
|---|---|
| Carbon | 1 commissioner |
| Daggett | 1 commissioner |
| Duchesne | 1 commissioner |
| Emery | 1 commissioner |
| San Juan | 1 commissioner |
| Sevier | 1 commissioner |
| Uintah | 1 commissioner |
...
- [Utah Division of Archives — Emery County Agency History (Entity 1513)](https://archives.utah.gov/research/entities/1513/)
- [Bureau of Land Management — Dingell Act, Utah](https://www.blm.gov/about/laws-and-regulations/dingell-act/utah)
- [SUWA — Emery County Public Land Management Act](https://suwa.org/emery_county/)
- [U.S. Department of the Interior — PILT Program](https://www.doi.gov/pilt)
- [Seven County Infrastructure Coalition](https://scic-utah.org/)
