...
This chapter profiles each major formal designation, traces its origin story, and describes what it offers the visitor today. The chapter should be read alongside <CrossRef chapter={30} />, which covers the broader informal recreation landscape of the San Rafael Swell, canyon country, and river corridors. Many of the most spectacular experiences in Emery County occur in areas that are neither named parks nor monuments but simply BLM multiple-use land — a reminder that in Emery County, the extraordinary is not confined to the designated.


<FigureImage
  src="/images/chapters/ch31_figure_designation-chronology.svg"
  alt="Two-lane chronology of protective designations in Emery County from 1954 to 2022, with state designations plotted above the axis and federal designations below. Four state parks arrive between 1954 and 1971, a forty-eight-year gap follows with no new park or monument, and the 2019 Dingell Act lands a cluster of federal designations on a single day"
  caption="Figure 31-A. Designating Emery County's protected lands, 1954–2022. Everything from 1954 to 1971 arrives inside seventeen years; forty-eight years then pass without a new park or monument designation; the Dingell Act lands a cluster in a single day."
  credit="Sources: Utah State Parks; Bureau of Land Management; Dingell Act, P.L. 116-9."
/>

<DataTable
  caption="Table 31-A — Formal designations in Emery County"
  note="Sources: Utah State Parks; Bureau of Land Management; Dingell Act, P.L. 116-9."
  id="table-31-a"
>

| Name | Type | Managing agency | Year designated | Size |
|---|---|---|---|---|
| Goblin Valley State Park | State park | Utah State Parks | 1954 (preserve); 1964 (park); expanded 2022 | 9,915 acres |
...
| Jurassic National Monument | National monument | BLM (National Conservation Lands) | 2019 | 850 acres |
| San Rafael Swell Recreation Area | Recreation area | BLM | 2019 | 216,995 acres (federal land) |
| Buckhorn Wash Pictograph Panel | Cultural site, NRHP-listed | BLM | NRHP listing year not established | Not published |
| The Wedge Overlook | Dispersed recreation | BLM (within the Recreation Area) | Within the 2019 Recreation Area | Not published |
...
The cliff faces visible from the overlook expose a nearly continuous sequence of the Triassic and Jurassic sedimentary formations that dominate the Colorado Plateau: Moenkopi Formation at the river level, overlain by Chinle Formation, Wingate Sandstone, Kayenta Formation, Navajo Sandstone, and Carmel Formation approaching the rim (see <CrossRef chapter={2} />). Each layer records a different ancient environment — shallow marine, river delta, aeolian desert, shallow marine again — laid down across a span of roughly 80 million years and now stacked in the cliff like the pages of a book. Geologists and students make the trip specifically to study the exposure; most visitors come simply to look.
...
County involvement in parks management extends beyond politics. The 2022 land transfer that tripled Goblin Valley also conveyed several parcels directly to Emery County — including the Sheriff's Office substation site and expanded land at the Buckhorn Information Center — recognizing that effective management of these sites requires county-level presence and investment. The Emery County Sheriff's Office (see <CrossRef chapter={29} />) plays a direct role in search and rescue operations throughout the slot canyons adjacent to Goblin Valley; the new substation gives those operations a forward base in an area where cellular communication is unreliable and response times from Castle Dale can be significant.


<FigureImage
  src="/images/chapters/ch31_figure_protected-area-scale.svg"
  alt="Horizontal bar chart on a logarithmic axis comparing the acreage of Emery County's protected areas, with the San Rafael Swell Recreation Area at 216,995 acres dwarfing Goblin Valley State Park, Jurassic National Monument, Huntington State Park, Millsite State Park, and Green River State Park"
  caption="Figure 31-B. Protected areas of Emery County by size (logarithmic axis). The San Rafael Swell Recreation Area is more than eighteen times the size of every other designation in this chapter combined."
  credit="Sources: Utah State Parks; Bureau of Land Management; Dingell Act, P.L. 116-9."
/>
...
- [Goblin Valley State Park](https://stateparks.utah.gov/parks/goblin-valley/) — Current fees, campground reservations, and alerts; reservations are advisable months ahead in peak season.
- [Jurassic National Monument](https://www.blm.gov/programs/national-conservation-lands/utah/jurassic-national-monument) — Visitor centre hours and current quarry-floor access status.
- [San Rafael Swell Recreation Area](https://www.blm.gov/visit/san-rafael-swell-recreation-area) — The 2019 Dingell Act designation, trailheads, and travel-management updates.
- [The Buckhorn Panel](https://www.blm.gov/visit/buckhorn-panel) — BLM site page for the Barrier Canyon style pictographs and the 1996 restoration.
- [The Wedge Overlook](https://www.blm.gov/visit/wedge) — Access, road conditions, and dispersed camping at the rim.
- [BLM ePlanning — San Rafael Swell Travel Management Plan](https://eplanning.blm.gov) — Record for the draft Travel Management Plan (June 2024) discussed in §31.4 and §31.12.
- [Utah Geological Survey GeoSights — Little Grand Canyon](https://geology.utah.gov/map-pub/survey-notes/geosights/little-grand-canyon/) — The stratigraphy visible from the Wedge Overlook, and the reference for the Youth Challenge sidebar.
- [Southern Utah Wilderness Alliance — Emery County](https://suwa.org/emery_county/) — A conservation-side account of the Emery County Public Land Management Act, useful as a counterweight to agency framing.
