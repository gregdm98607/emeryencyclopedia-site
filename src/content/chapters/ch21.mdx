...
<FigureImage
  src="/images/chapters/ch21_figure_energy-transition-timeline.png"
  alt="Timeline of Emery County's energy transition, 1974-2026"
  caption="Figure 21-A. Energy transition milestones, 1974–2026: coal infrastructure, coal-decline shocks, and renewable-energy milestones."
  credit="Source: High Country News/MIT, Utah News Dispatch, BusinessWire, @theU, Salt Lake Tribune, Utah DEQ"
/>
...
<DataTable
  caption="Table 21-A — Emery County energy facilities summary"
  note="Sources: Global Energy Monitor (Hunter, Huntington); University of Utah @theU (Castle Solar); BusinessWire / Utah News Dispatch (GREC); Utah DEQ / Salt Lake Tribune (Lila Canyon). Huntington capacity carries the chapter's [needs verification] flag — not asserted as confirmed."
  id="table-21-a"
>

| Facility | Type | Capacity | Owner | Online | Employment | Status (2026) |
|---|---|---|---|---|---|---|
| Hunter Plant | Coal | ~1,577 MW (3 units) | PacifiCorp / UAMPS / Deseret Power | 1978 | ~300+ | Operating — no retirement date in 2025 IRP |
| Huntington Plant | Coal | ~1,037 MW (2 units) *[needs verification]* | PacifiCorp | 1974 | 187 | Operating — no retirement date in 2025 IRP |
| Castle Solar | Solar | 40 MW AC | Castle Solar LLC | Apr 2024 | small (perm.) | Operating |
| Green River Energy Center | Solar + storage | 400 MW / 1,600 MWh | rPlus Energies | est. 2026 | 15–20 (perm.); up to 500 (constr.) | Under construction 2024–2026 |
| Lila Canyon Mine | Underground coal | — | Emery County Coal Resources (ACNR/Murray estate) | 1980s–2024 | 152 (at closure) | Sealed Jan 2024 |
...
<DataTable
  caption="Table 21-B — Green River Energy Center at a glance"
  note="Sources: BusinessWire (Sep 2024); Utah News Dispatch (Sep 2024); Utah Business (May 2025)."
  id="table-21-b"
>

| Spec | Value |
|---|---|
| Solar capacity | 400 MW PV |
| Battery storage | 400 MW / 1,600 MWh |
| Homes powered (energy-equivalent) | ~88,000 |
| Construction financing | >$1.1 billion |
| Construction jobs | up to 500 |
| Permanent jobs | 15–20 |
| Projected property tax (project life) | ~$55 million |
| Groundbreaking / est. operational | Sep 2024 / late spring 2026 |
...
The workforce challenge is inseparable from a demographic one. Emery County's population declined from 11,004 in 2010 to approximately 10,144 by 2023 — a loss of roughly 860 residents, or 7.55 percent (U.S. Census Bureau, 2024). By 2025, the population had stabilized at approximately 10,173, with a growth rate of 0.12 percent — essentially flat (Kem C. Gardner Policy Institute, February 2025). Eight Utah counties, including Emery, reported population decreases in recent estimates, with outmigration combining with a birth-death balance that no longer generates natural increase (KUER, February 2025) — a pattern treated in full in the county's demographic chapter (see <CrossRef chapter={22} />).
...
<DataTable
  caption="Table 21-C — Emery County economic indicators (2023)"
  note="Sources: U.S. Census Bureau (2024); DataUSA (2023); Kem C. Gardner (2025); High Country News / MIT Climate Portal (EIA data)."
  id="table-21-c"
>

| Indicator | Value |
|---|---|
| Population (2010 / 2023 est. / 2025 est.) | 11,004 / ~10,144 / ~10,173 |
| Top employment sectors (2023, by headcount) | Educational Services 532 · Construction 453 · Retail Trade 438 |
| Utah coal production 2010 → 2020 | ~13 Mt → 5.2 Mt (≈ −60%) |
| Coal-dependent-county employment 2008–2018 | −21% (vs +21% statewide) |
...
- [Kem C. Gardner Policy Institute — Long-Term Planning Projections, Utah's Coal Counties](https://gardner.utah.edu/news/long-term-planning-projections-highlight-economic-challenges-opportunities-in-utahs-coal-counties/)
- [U.S. Energy Information Administration — Utah Coal Production Data](https://www.eia.gov)
- [U.S. Economic Development Administration — Utah Rural Energy Diversification & Innovation Cluster](https://www.eda.gov/sites/default/files/2022-09/Utah_Rural_Energy_Diversification_&_Innovation_Cluster.pdf)
- [rPlus Energies / BusinessWire — Green River Energy Center Groundbreaking](https://www.businesswire.com/news/home/20240920988821/en/rPlus-Energies-Breaks-Ground-on-a-400-Megawatt-Solar-PV-and-400-MW-1600-Megawatt-Hour-Battery-Green-River-Energy-Center)
