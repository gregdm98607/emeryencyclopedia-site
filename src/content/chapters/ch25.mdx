...
<FigureImage
  src="/images/chapters/ch25_figure_adherents-2020.png"
  alt="Horizontal bar chart of religious adherents in Emery County by body, 2020"
  caption="Figure 25-B. Religious adherents in Emery County by body, 2020: LDS 5,526 (91.5%), Roman Catholic 300, non-denominational Christian ~200. Shares are of counted adherents (6,039 total), not of total population."
  credit="Source: 2020 U.S. Religion Census, Association of Statisticians of American Religious Bodies, via ARDA"
/>

<DataTable
  caption="Table 25-A — Religious Adherents in Emery County, 2020"
  note="Shares are of counted adherents, not of total population. The Southern Baptist Convention is described as accounting for a handful more adherents without a discrete figure. Source: 2020 U.S. Religion Census via ARDA."
  id="table-25-a"
>

| Religious body | Adherents | Congregations | Share of adherents |
|---|---|---|---|
| The Church of Jesus Christ of Latter-day Saints | 5,526 | 18 | 91.5% |
| Roman Catholic Church | 300 | 2 | 5.0% |
| Non-denominational Christian | ~200 | 1 | ~3.3% |
| Southern Baptist Convention | not separately reported | — | — |
| Total adherents | 6,039 | — | 100% |
| Estimated county population | 9,825 | — | 61.5% affiliated |
...
Long before Brigham Young's 1877 call sent settlers to Castle Valley, the canyons and benches of what is now Emery County held some of the densest concentrations of religious imagery in the American West. Rock art panels at Buckhorn Wash, Black Dragon Canyon, Rochester Creek, Temple Mountain Wash, Muddy Creek, and Ferron Box (see <CrossRef chapter={12} />) record at least three distinct cultural traditions: the Barrier Canyon Style (estimated 3,000 BCE–500 CE), the Fremont culture (roughly 300–1300 CE), and later Numic-speaking peoples — ancestors of today's Ute and Southern Paiute — whose imagery overlays older surfaces.
...
For the Indigenous peoples whose ancestors made these images, the panels are not artifacts of a vanished culture but elements of an ongoing relationship to place. The Ute Indian Tribe of the Uintah and Ouray Reservation, the Navajo Nation, the Hopi Tribe, and the San Juan Southern Paiute Tribe have all asserted ancestral and cultural connections to landscapes within or adjacent to Emery County. Federal land managers — primarily the Bureau of Land Management, which administers most of the county's public lands — engage in formal consultation with these tribes under the Native American Graves Protection and Repatriation Act (NAGPRA, 1990), the Archaeological Resources Protection Act (ARPA, 1979), and Section 106 of the National Historic Preservation Act (1966) when actions might affect sacred sites (see <CrossRef chapter={13} />). Increasingly, interpretive signage and educational programs at the Buckhorn and San Rafael panels reflect collaborative authorship rather than the older convention of treating Indigenous religion in the past tense.

## 25.3 Mormon Foundation: The Emery Stake (1880) and Its Wards

<FigureImage
  src="/images/chapters/ch25_figure_religious-timeline.png"
  alt="Timeline of religious life in Emery County, 1877-2025, color-coded by tradition"
  caption="Figure 25-A. Religious life in Emery County, 1877-2025. Color indicates tradition. The 1959 closure date of the Ferron Presbyterian congregation is contested in the sources."
  credit="Source: Chapter 25 body and cited sources (ARDA; FamilySearch; NRHP files; Utah History Encyclopedia; CNEWA; Church News)"
/>

When Brigham Young issued his last colonizing call in the summer of 1877 — instructing leaders in Sanpete County to send families east across the Wasatch Plateau into Castle Valley (see <CrossRef chapter={16} />) — the religious organization of the new settlements was implicit in the call itself. Mormon colonization in the late territorial period was inseparable from ecclesiastical organization: pioneers traveled as members of wards, settled in patterns dictated by stake-level leadership, laid out townsites with central squares reserved for chapel and school, and reported their progress to general authorities in Salt Lake City. Within three years of the first settlements at Ferron, Castle Dale, Huntington, and Orangeville, the Emery Stake of Zion was organized — on December 9, 1880, the same year Emery County itself was carved out of Sanpete and Sevier counties (FamilySearch, 2025; Castle Dale Utah Stake history).
...
<DataTable
  caption="Table 25-B — Emery Stake Wards and Branches"
  note="Emery Stake wards and branches as named in this chapter, from FamilySearch, Emery Stake, Utah LDS Church Wards and Branches. The stake encompassed twelve wards and branches by 1930; ten are named here. The two unnamed units are not supplied."
  id="table-25-b"
>

| Unit | Type | Community served |
|---|---|---|
| Castle Dale | Ward | Castle Dale (stake headquarters) |
| Huntington | Ward | Huntington |
| Ferron | Ward | Ferron |
| Orangeville | Ward | Orangeville |
| Cleveland | Ward (organized slightly later) | Cleveland |
| Emery | Ward (organized slightly later) | Emery |
| Lawrence | Branch | Lawrence irrigation hamlet |
| Mohrland | Branch | Mohrland coal camp |
| Rochester | Branch | Rochester |
| Victor | Branch | Victor ranching settlement |
...
<DataTable
  caption="Table 25-C — Religious Heritage Buildings on the National Register"
  note="Source: National Register of Historic Places files (1978, 1980); HMDB historical marker. The Castle Dale Stake Center is omitted: its construction year needs verification and no undated row is worth a table line here."
  id="table-25-c"
>

| Building | Location | Built | NRHP listed | Significance |
|---|---|---|---|---|
| Emery LDS Church | Town of Emery | 1898-1900; dedicated 27 July 1902 | 1980 | Oldest remaining religious building in the county; last surviving "New England" clapboard Mormon meetinghouse in Utah. Wood frame, clapboard sheathing, non-load-bearing adobe interior walls. Final cost $7,000. |
| Ferron Presbyterian Church and Cottage | Mill Road & 200 East, Ferron | 1908 | 1978 | Gothic Revival combined chapel, parsonage, and mission school; built by the Christian Endeavor Society. Congregation active approx. 1906-1959. |
...
- [Association of Religion Data Archives — U.S. Religion Census County Membership Reports](https://www.thearda.com/us-religion/statistics/rankings)
- [National Register of Historic Places](https://www.nps.gov/subjects/nationalregister/)
- [Utah History Encyclopedia — The Presbyterian Church in Utah](https://www.uen.org/utah_history_encyclopedia/p/PRESBYTERIAN_CHURCH_IN_UTAH.shtml)
- [Utah History Encyclopedia — Greeks in Utah](https://www.uen.org/utah_history_encyclopedia/g/GREEKS_IN_UTAH.shtml)
- [FamilySearch — Emery Stake, Utah LDS Church Wards and Branches](https://www.familysearch.org/en/wiki/Emery_Stake,_Utah_LDS_Church_Wards_and_Branches)
- [Kem C. Gardner Policy Institute — Utah Religious Affiliation Databook (May 2024)](https://d36oiwf74r1rap.cloudfront.net/wp-content/uploads/2024/05/DivDataBook-Religion-May2024.pdf)
