...
<FigureImage
  src="/images/chapters/ch34_opensource_desert_bighorn_ram.jpg"
  alt="Desert bighorn ram with chin raised, displaying characteristic posture"
  caption="Figure 34.1. A desert bighorn ram (*Ovis canadensis nelsoni*) — the San Rafael Swell's signature animal. The county holds Utah's largest desert bighorn herd, descended from reintroduction efforts begun in the 1970s after near-extirpation from the region."
  credit="Andrew Cattoir / National Park Service / Public Domain"
/>
...
<FigureImage
  src="/images/chapters/ch34_opensource_elk_bull_bugling.jpg"
  alt="Bull elk bugling with head raised during the fall rut at Yellowstone"
  caption="Figure 34.2. A bull elk in full bugle during the fall rut. From campsites at Joe's Valley Reservoir or along the upper Huntington Canyon road, the same high, breath-held cry — breaking into deep grunts — carries for miles in the still morning air."
  credit="Addy Falgoust / National Park Service — Yellowstone / Public Domain"
/>
...
<FigureImage
  src="/images/chapters/ch34_opensource_pronghorn_buck_grassland.jpg"
  alt="Pronghorn buck with full horns in open grassland"
  caption="Figure 34.3. A pronghorn buck in open grassland — the species that frequents the sagebrush flats along SR-10 between Ferron and the Wedge Overlook. Capable of sustained 55-mph runs, the pronghorn is the second-fastest land mammal on Earth."
...
<FigureImage
  src="/images/chapters/ch34_opensource_golden_eagle_flight.jpg"
  alt="Adult golden eagle in powered flight with wings spread"
  caption="Figure 34.4. A golden eagle (*Aquila chrysaetos*) in powered flight — adults reach wingspans of 6 to 7 feet. Year-round residents of the San Rafael Swell, golden eagles soar the thermals above the Reef and Book Cliffs, hunting rabbits and ground squirrels on the desert benches below."
...
<FigureImage
  src="/images/chapters/ch34_opensource_bald_eagle_cottonwood.jpg"
  alt="Adult bald eagle perched in a cottonwood tree"
  caption="Figure 34.5. An adult bald eagle perched in a cottonwood — the signature winter raptor of Emery County's Green River corridor. From late November through February, concentrations gather in the cottonwood stands above the Green, easily viewed from Green River State Park."
  credit="Mara Koenig / U.S. Fish and Wildlife Service / Public Domain"
/>
...
<FigureImage
  src="/images/chapters/ch34_opensource_collared_lizard_male.jpg"
  alt="Eastern Collared Lizard male with emerald-green coloring and black neck collar"
  caption="Figure 34.6. An Eastern Collared Lizard (*Crotaphytus collaris*) male — emerald-green body, prominent black neck collar, and the sunning posture on a rock that makes this the Swell's most conspicuous reptile on any warm morning. Males are capable of running on their hind legs when pursued."
  credit="Rstanton13 / CC BY-SA 4.0 via Wikimedia Commons"
/>
...
<DataTable
  caption="Table 34-E — Reservoir Fisheries Summary"
  note="Source: Ch34 §34.8; Utah DWR Fish Utah / Blue Ribbon fisheries."
  id="table-34-e"
>

| Reservoir | Size / Depth | Species | Access |
|---|---|---|---|
| Joe's Valley Reservoir | ≈1,192 acres; max depth 168 ft, avg 44 ft | Cutthroat trout, rainbow trout, tiger muskie, trophy splake | Utah DWR Blue Ribbon fishery |
| Huntington North Reservoir | — | Wipers, rainbow trout, bluegill, largemouth bass, channel catfish | — |
| Millsite Reservoir | — | Rainbow and brown trout | — |
...
A different kind of wildlife watching is available at the Cleveland-Lloyd Dinosaur Quarry, the centerpiece of the Jurassic National Monument (see <CrossRef chapter={31} />) designated by the same 2019 Dingell Act that created the San Rafael Swell Recreation Area (see <CrossRef chapter={30} />). The quarry, on BLM-managed land about 33 miles from Price and 21 miles from Huntington (the last 11 miles on a graded dirt road), contains the densest concentration of Jurassic dinosaur fossils ever found anywhere on Earth.
...
For the visitor, the on-site visitor center houses interactive displays, bone-bed maps, replica skulls, and an *Allosaurus* skeleton mount. Walking the quarry boardwalk and reading the layered geology of the Morrison Formation — the rock unit that yields nearly all of the great dinosaur fossils of the American West (see <CrossRef chapter={2} />) — connects modern wildlife watching to the deep evolutionary past. *Allosaurus* hunting *Camarasaurus* in Emery County 150 million years ago is the same drama, in different actors, as Cougar hunting Mule Deer in the Wasatch Plateau today.

<FigureImage
  src="/images/chapters/ch34_opensource_cleveland_lloyd_fossil_display.jpg"
  alt="Allosaurus skeletal casts depicting the Cleveland-Lloyd Quarry bone bed at the Natural History Museum of Utah"
  caption="Figure 34.7. Allosaurus skeletal casts depicting the Cleveland-Lloyd Dinosaur Quarry bone-bed accumulation, on display at the Natural History Museum of Utah. The quarry in Emery County has yielded more than 12,000 fossil bones — the densest concentration of Jurassic dinosaur fossils ever found on Earth."
  credit="Jens Lallensack / CC BY-SA 4.0 via Wikimedia Commons"
/>
...
<FigureImage
  src="/images/chapters/ch34_figure_seasonal-calendar.png"
  alt="Horizontal timeline chart showing eleven wildlife-watching activity windows across the twelve months of the year, color-coded by habitat zone"
  caption="Figure 34-A. The Emery County wildlife-watching seasonal calendar. Eleven activity windows — bighorn lambing, fawning, elk rut, bighorn rut, spring and raptor migration, deer migration, bald eagle/waterfowl arrival, reptile activity, and wildflower/pollinator season — plotted across the year and keyed by habitat zone."
  credit="Original chart for this work; data per §34.11 and species accounts §34.2–34.8."
/>
...
<DataTable
  caption="Table 34-C — Recommended Watching Distances"
  note="Source: Ch34 §34.12; Utah DWR wildlife-viewing ethics."
  id="table-34-c"
>

| Category | Minimum distance |
|---|---|
| Small mammals | 50 yards |
| Large mammals | 100 yards |
| Predators and nesting raptors | 200 yards |

</DataTable>

<DataTable
  caption="Table 34-D — Federally Protected & Recovered Wildlife"
  note="Source: Ch34 §34.5/§34.8/§34.12; USFWS listing records; Utah DWR."
  id="table-34-d"
>

| Species | Status | Notes |
|---|---|---|
| Bald eagle | Delisted 2007; protected under BGEPA | Winters along the Green River corridor |
| Peregrine falcon | Delisted 1999 | Nests on Swell cliff bands |
| Flannelmouth sucker, bluehead sucker, roundtail chub ("Three Species") | Declining natives; agency conservation focus | San Rafael and Green River warm-water fish |
| Humpback chub, Colorado pikeminnow, bonytail chub, razorback sucker | ESA endangered | Green River through Emery County is designated Critical Habitat |
| Desert bighorn sheep | State-managed recovery | Utah's largest herd, San Rafael Swell |
| Mexican spotted owl | ESA threatened | Cliff and canyon habitat |
...
- BLM — San Rafael Swell Recreation Area: [blm.gov/visit/san-rafael-swell-recreation-area](https://www.blm.gov/visit/san-rafael-swell-recreation-area)
- USFWS — Upper Colorado River Endangered Fish Recovery Program: [fws.gov/office/upper-colorado-river-endangered-fish-recovery-program](https://www.fws.gov/office/upper-colorado-river-endangered-fish-recovery-program)
- Utah DWR — Wildlife Viewing: [wildlife.utah.gov/viewing](https://wildlife.utah.gov/viewing)
- Cornell Lab — eBird, Emery County: [ebird.org](https://ebird.org)
- iNaturalist — Emery County: [inaturalist.org/places/emery-county](https://www.inaturalist.org/places/emery-county)
