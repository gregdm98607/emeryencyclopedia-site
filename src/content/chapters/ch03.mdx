...
<Factbox
  ...
  rows={[
    { label: "Dissolved solids — water diverted from creeks", value: "357 mg/L" },
    { label: "Dissolved solids — water returning to Green River", value: "4,170 mg/L" },
    { label: "Concentration increase", value: "11.7× saltier" },
    { label: "Annual salt load to Green River (Green River area)", value: "~15,700 tons/year" }
  ]}
