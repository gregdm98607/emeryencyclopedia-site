...
<FamilyActivity
  ...
  ageRange="Ages 6+"
  duration="30 min"
  description="Shape a miniature landscape on a large baking sheet: mountains on one end (the Wasatch Plateau), a valley in the middle (Castle Valley), and a low channel on the far side (the Green River). Dust the mountain peaks with flour or baking soda to represent snowpack. Use a spray bottle with blue-tinted water to simulate spring melt, then watch where the water flows, where it pools, and where it rushes. Ask: Where would you build a dam to store water for the dry months? Where would you dig a canal? Where would a flash flood be most dangerous? This is the same gravity-driven system that shaped every farm, town, and canyon in Emery County."
  materials={["Large baking sheet or shallow plastic bin", "Modeling clay or Play-Doh", "Spray bottle with blue-tinted water", "Flour or baking soda (for snowpack)", "Pencil or straw to sketch canal routes"]}
/>
...
Groundwater quality in Emery County mirrors the geologic diversity of the subsurface. In shallow alluvial aquifers near Green River, dissolved solids concentrations measured during a 2004–05 USGS study ranged from 687 to 55,900 milligrams per liter (mg/L) — a variation driven largely by proximity to the Mancos Shale, which releases selenium, sulfate, and other dissolved constituents as it weathers (USGS SIR 2006/5186) (see <CrossRef chapter={2} />). Deeper bedrock aquifers in the Navajo Sandstone and other Mesozoic formations generally produce cleaner water, though access depends on depth and local geologic structure.
...
<DataTable
  caption="Table 3-B — Water Chemistry: Upstream vs. Downstream"
  note="Source: USGS SIR 2006/5186 (Blanchard, 2006); chapter §3.6."
  id="table-3-b"
>

| Site / condition | Dissolved solids (mg/L) | Note |
|---|---|---|
| Upstream creeks (above diversions) | < 500 | Wasatch Plateau limestone/sandstone source |
| Irrigation water diverted | 357 (mean) | Clean diversion water |
| San Rafael River across Mancos Shale | > 2,000 | All but highest snowmelt flows |
| Agricultural return flow to Green River | 4,170 (mean) | 11.7× the diverted concentration |
| Strontium (7 San Rafael basin sites) | > 1,500 µg/L | — |
| Salt loading to Green River (near town) | ~15,700 tons/yr | Estimated |

</DataTable>

<DataTable
  caption="Table 3-C — Canal Seepage Losses (May–October)"
  note="Source: USGS SIR 2006/5186 (Blanchard, 2006)."
  id="table-3-c"
>

| Canal | Seepage loss (acre-ft) |
|---|---|
...
<Factbox
  ...
  note="Fifteen thousand tons of salt is roughly 115 loaded coal cars — dissolved from ancient sea-floor rock and flushed into the Colorado River system every single year."
/>
...
Statewide, August is the most active flood month in Utah, accounting for 465 recorded flood events — roughly 35 percent of all flood records in the state. Emery County's share of these events is concentrated in the slot canyons of the San Rafael Swell — Little Wild Horse Canyon, Crack Canyon, Bell Canyon, and others — where recreational hikers are particularly vulnerable to sudden water rises in confined passages (see <CrossRef chapter={30} />).
...
The centerpiece of this infrastructure is the **Emery County Project**, a Bureau of Reclamation initiative whose construction commenced on June 20, 1963, and was substantially completed by 1966 (see <CrossRef chapter={19} />). The project's keystone structure is **Joes Valley Dam and Reservoir**, an earthfill dam on Seely Creek containing 1,290,000 cubic yards of material. The dam rises 187 feet above the streambed with a crest length of 750 feet, impounding a reservoir with a total capacity of 62,460 acre-feet (active storage approximately 54,920 acre-feet) and a surface area of 1,170 acres. Joes Valley Reservoir is the single largest storage facility in the San Rafael basin and the primary source of supplemental irrigation water for Castle Valley farms (see <CrossRef chapter={20} />).
...
<DataTable
  caption="Table 3-A — Major Reservoirs of the San Rafael Basin"
  note="Source: Bureau of Reclamation, Emery County Project; USGS (1978); EWCD."
  id="table-3-a"
>

| Reservoir | Capacity (acre-ft) | Surface area (acres) | Dam / structure | Completed | Manager |
|---|---|---|---|---|---|
| Joes Valley | 62,460 (active ~54,920) | 1,170 | Earthfill, 187 ft high, 750 ft crest, on Seely Creek | 1966 | EWCD |
| Huntington North | 5,420 | 242 | Off-stream storage | — | EWCD |
| Millsite | — | — | On Ferron Creek | — | EWCD |
| Swasey Diversion | (diversion) | — | Concrete ogee weir, 11 ft, 75 ft crest; up to 165 cfs | 1960s | EWCD |
| Basin total (8 major reservoirs, late 1970s) | ~115,000 | — | — | — | — |
...
<ScavengerHunt
  ...
  location="Joes Valley Reservoir, Huntington Creek, or the town of Green River"
  items={[
    "At Joes Valley Reservoir — Find the dam face. The dam rises 187 feet above the streambed. Can you spot where Seely Creek enters the reservoir? Look for the muddy delta where sediment builds up near the inlet.",
    "Along Huntington or Cottonwood Creek — Locate an irrigation headgate or canal entrance. Is water being diverted right now? Which direction does the canal run? Sketch the diversion structure in your notebook.",
    "At the Green River in Green River (town) — Stand on the bridge and look west. Can you see where the San Rafael River enters? What color is the Green River water today — clear, green-brown, or muddy?",
    "In any San Rafael Swell slot canyon (adult supervision required) — Find the highest water mark on the canyon wall. How far above the canyon floor does it reach? What debris — sticks, mud, rocks — tells you a flood has passed here?"
  ]}
...
More than 95 percent of Utah's water supply begins as snow, and Emery County is no exception. The Wasatch Plateau snowpack — accumulating from October through April at elevations above 9,000 feet — is the county's primary water bank (see <CrossRef chapter={4} />). When the snowpack is deep and melts gradually, reservoirs fill, creeks run strong through the irrigation season, and groundwater recharge proceeds. When the snowpack is thin or melts too early, everything downstream suffers.
...
<DataTable
  caption="Table 3-D — USGS Streamflow Gaging Stations, Emery County"
  note="Source: USGS Water Data for the Nation."
  id="table-3-d"
>

| Station | Name | Note |
|---|---|---|
| 09315000 | Green River at Green River | Mean annual ~6,100 cfs (post-Flaming Gorge regulation) |
| 09328500 | San Rafael River near Green River | Snowmelt-dominant regime |
| 09328910 | San Rafael River at mouth | Ranges from a few cfs to several thousand cfs |
...
- [USGS Scientific Investigations Report 2006/5186](https://pubs.usgs.gov/sir/2006/5186/) — Hydrology and water quality in the Green River and surrounding agricultural areas near Green River, Emery and Grand Counties, Utah, 2004–05 (Blanchard, 2006) — the chapter's core water-quality source.
- [USGS Water Data for the Nation (NWIS)](https://waterdata.usgs.gov/ut/nwis/) — Real-time streamflow gages for Utah, including Emery County stations.
- [Utah Division of Water Rights, Area 93](https://www.waterrights.utah.gov) — Appropriation records for the San Rafael drainage.
- [Emery Water Conservancy District](https://ewcd.org) — Reservoir and canal real-time data.
- [UGS Groundwater Monitoring Portal](https://gwportal.geology.utah.gov) — Well and spring records.
...
<FieldItinerary
  site="The Water Trail: Snowmelt to Salt"
  tagline="Follow a drop of water 80 miles from the Wasatch Plateau to the Green River."
  gettingThere="Start on SR-31 in Huntington Canyon, drive through Castle Valley via US-6 and SR-10, cross I-70 at the San Rafael River, and end at Green River State Park. Approximately 120 miles total."
  timeNeeded="Full day (6–8 hours with stops)"
  bestSeason="May–June for peak snowmelt and active canal flows; September–October for low-water San Rafael River"
  whatToBring="Water and snacks (limited services in canyon areas), binoculars, a notebook for water observations"
  onTheGround="Stop 1 — Huntington Canyon above 8,000 ft: in spring, snowmelt cascades directly off the plateau — this is where Emery County's water supply begins. Stop 2 — Huntington North Reservoir: compare the waterline to the high-water mark on the shore; in drought years the gap tells the whole story. Stop 3 — A Castle Valley irrigation canal (Huntington, Castle Dale, or Orangeville): in summer this is snowmelt traveling to alfalfa fields. Stop 4 — San Rafael River at I-70: the Mancos Shale badlands visible here are where water's dissolved solids jump 11.7× as it flows east toward the Green River. Stop 5 — Green River State Park: every drop that started in Huntington Canyon ends up here — you have followed a single drop of water across 80 miles and 6,000 feet of elevation."
  seeAlso={["Chapter 2 (Geology)", "Chapter 4 (Climate & Weather)"]}
/>
