...
Long before the railroad, Emery County existed on a crossroads. The Old Spanish Trail, linking Santa Fe, New Mexico, to Los Angeles, California, traversed Castle Valley around the turn of the 19th century (see <CrossRef chapter={14} />). Spanish traders and explorers used the trail for centuries, driving horses northbound and human captives southbound in a tragic commerce. The landscape itself named the route: early Spanish travelers marveled at the imposing red-rock formations of Castle Valley, and the name persisted.
...
The first recorded U.S. travelers on the Spanish Trail arrived in 1809; William Wilfskill documented his passage through Castle Valley in 1830. When the LDS church directed settlement southeastward in 1877, families were sent to homestead Huntington, Ferron, Castle Dale, and Orangeville (see <CrossRef chapter={16} />)—communities that emerged along the same drainages and resource nodes the Spanish Trail had identified generations earlier. The specifics of wagon roads connecting these pioneer settlements in the 1880s and 1890s—their names, exact routes, maintenance regimes—are poorly documented, though their existence is certain: every community needed access to the others, and every wagon left ruts that defined the landscape.
...
The Hiawatha mines—initially called Black Hawk—represented a more ambitious extension. Work on the Utah Railway's line between Hiawatha and Castle Gate began September 10, 1912. This 28-mile grade, running south from Mohrland toward Helper, was designed to consolidate the scattered mining operations of Carbon and Emery counties into one efficient network. The Black Hawk Coal Company's mines, sold to United States Fuel Company in 1912, became integrated into the larger regional system. By 1913, a new regional identity was emerging: no longer isolated local collieries, but parts of a rationalized, interconnected coal-mining complex — the same branch lines and the mines they served that are explored in full in <CrossRef chapter={17} />.

<DataTable
  caption="Table 18-B — Rail lines serving the coalfields"
  note="Sources: utahrails.net, 'Rio Grande in Utah, Sunnyside Branch' and 'Castle Gate Coal Mines'; §§18.2–18.3."
  id="table-18-b"
>

| Line | Built | Length | Owner | Served | Fate |
|---|---|---|---|---|---|
| D&RGW mainline through Price River Canyon | Utah–Colorado connection 30 March 1883; revenue traffic 1 April | — | Denver & Rio Grande Western | The whole regional coal trade | Still the trunk line |
| Castle Gate connection | Commercial production formalized 1888 | — | Pleasant Valley Coal Co. | Castle Gate mines | Grew organically around the line rather than being extended to it |
| Sunnyside Branch | 1899 | 17 miles, Mounds to Sunnyside | Carbon County Railway (D&RGW subsidiary) | Utah Fuel Co. mines; Banning Coal Loadout at mile 5.5 | Kaiser Steel 1943; operated until 1991 |
| Utah Railway, Hiawatha–Castle Gate | Grade begun 10 September 1912 | 28 miles, Mohrland toward Helper | Utah Railway | Black Hawk / U.S. Fuel Co. mines | Consolidated scattered Carbon and Emery operations into one network |
...
<DataTable
  caption="Table 18-C — Federal highways serving Emery County"
  note="Sources: FHWA, 'U.S. 6 — The Grand Army of the Republic Highway'; §§18.5, 18.7."
  id="table-18-c"
>

| Route | Established | Corridor | Significance |
|---|---|---|---|
| US-6 (Grand Army of the Republic Highway) | 1926, one of the original U.S. routes | East–west; Price and Helper, then down toward Green River | Ran parallel to or supplemented the railroad; trucks began competing with trains |
| US-50 | 1926 | Nevada → Utah → Colorado, through Green River | Made Green River a highway town as well as a rail town |
| US-191 | Most of the current route dates to 1981 | Moab – Green River – Price – Vernal | Wove the county into a north–south commercial corridor |
| I-70 | Construction 1963; first section open 1970; four-lane complete 1990 | Across the San Rafael Swell | Connection to the national system, at the price of extreme on-route isolation |
...
<DataTable
  caption="Table 18-A — Crossing the Green River, 1876–1946"
  note="Sources: §18.6; Utah Stories from the Beehive Archive, 'Division & Connection: The Green River Crossing'; Utah History to Go, 'Green River.'"
  id="table-18-a"
>

| Year | Crossing | Note |
|---|---|---|
| 1876 | Blake's Ferry | Ferry and way station on the east bank; the town's first commerce point, seven years ahead of the railroad |
| 1883 | D&RGW railroad bridge | Swift, reliable, capital-intensive — and reserved to the railroad |
| 1883–1910 | Ferry continues | General freight and passenger traffic still depended on Blake's Ferry for roughly 30 years after the rail bridge opened |
| 1910 | Wagon bridge | Road traffic finally freed from ferry service |
| 1946 | Wagon bridge collapses | Failure after 36 years; travel and commerce disrupted on both banks |
| after 1946 | Replacement bridge | Rebuilt under urgency; the failure remained in local memory |

</DataTable>

The Green River was never just geography; it was a narrative of infrastructure failure and repair, of ferries giving way to bridges, of old systems breaking and new ones taking their place.
...
The result is the "loneliest interstate" in America. From Green River to Salina, more than 110 miles, there are no gas pumps, no restaurants, no services whatsoever. For the final 100 miles, there is no place to buy gasoline, food, water, or use a restroom. The highway connects Emery County to the national system, but it does so by passing through terrain so severe that exit infrastructure—gas stations, restaurants, rest areas—is economically unviable. The I-70 through the San Rafael Swell is a highway of extreme isolation — a modern route layered over the older ways travelers found around and through the Swell (see <CrossRef chapter={32} />).

<FigureImage
  src="/images/chapters/ch18_figure_infrastructure-timeline.png"
  alt="Timeline of Emery County infrastructure milestones, 1876–1990"
  caption="Figure 18-A. Infrastructure milestones, 1876–1990: from Blake's Ferry through the D&RGW mainline, federal highways, and the completion of Interstate 70 across the San Rafael Swell."
  credit="Source: events as cited in §§18.1–18.7"
/>

<FigureImage
  src="/images/chapters/ch18_figure_i70-service-gap.png"
  alt="Schematic of the Interstate 70 service gap across the San Rafael Swell"
  caption="Figure 18-B. Interstate 70 across the Swell: the service gap. A schematic, not a map — drawn to scale along one axis only."
  credit="Source: §§18.7, 18.11"
/>

<DataTable
  caption="Table 18-D — Interstate 70 across the San Rafael Swell"
  note="Sources: Utah History to Go, 'Interstate 70'; §18.7."
  id="table-18-d"
>

| Item | Detail |
|---|---|
| Planning / construction begins | Early 1960s; construction 1963 |
| First section open to traffic | 5 November 1970 |
| Formal dedication | 5 December 1970, at Ghost Rocks — ceremonial; the highway was not yet to Interstate standards |
| Standards change | Congress raised Interstate standards during the 1970s from two lanes to four, requiring widening through the 1980s |
| Completion | Eagle Canyon bridge dedication, October 1990 — 20 years after opening, 27 after construction began |
| Cost, eight-mile segment | $4.5 million (1970 dollars) |
| Rock excavated | 3.5 million cubic yards |
| Total Swell segment | ~$388 million (1990 dollars) |
| Service gap | 110+ miles, Green River to Salina — no fuel, food, water, or restrooms |
...
<DataTable
  caption="Table 18-E — Airports"
  note="Source: §18.8. Huntington operational data is not established in available records and is left blank rather than estimated."
  id="table-18-e"
>

| | Green River Municipal | Huntington Municipal |
|---|---|---|
| Owner / operator | Green River City Corp. | Municipal |
| Location | 5 mi southwest of Green River | South of the Green River facility |
| Elevation | 4,234 ft | *no data — see §18.8* |
| Runway | 5,600 × 75 ft asphalt, 13/31 | *no data* |
| 2023 operations | 2,003 (~70% general aviation, ~30% air taxi) | *no data* |
| FAA classification | General aviation, National Plan of Integrated Airport Systems | *no data* |

</DataTable>

These airports are not glamorous or high-traffic facilities.
...
- [Federal Highway Administration — U.S. 6, The Grand Army of the Republic Highway](https://www.fhwa.dot.gov/infrastructure/us6.cfm)
