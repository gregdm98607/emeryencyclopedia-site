...
The catalyst for industrial development came from the railroad. In 1881, a geologist working for the Denver and Rio Grande Western identified a coal deposit suitable for locomotive fuel in the canyons above Price. Castle Gate Mine No. 1 opened in 1886, operated by the Pleasant Valley Coal Company — a railroad subsidiary — and by the late 1880s the D&RGW was hauling coal from Castle Gate, Winter Quarters, and Clear Creek to markets throughout the Intermountain West (Legends of America, "Castle Gate, Utah") — the same rail network whose full history is traced in <CrossRef chapter={18} />. Those early operations lay just across the county line in Carbon County, but the coalfield itself spread south onto the Wasatch Plateau into what would become Emery County territory, and the workforce, infrastructure, and corporate arrangements established in the 1880s set the template for every coal camp that followed.

<FigureImage
  src="/images/chapters/ch17_figure_extractive-timeline.svg"
  alt="Tiered timeline of Emery County's extractive century, 1881 to 2024, showing coal and uranium cycles and the Wilberg and Crandall Canyon disasters"
  caption="Figure 17-B. Emery County's extractive century, 1881–2024. Coal and uranium ran as separate, offset cycles rather than one continuous extractive era."
  credit="Source: Chapter 17 body and cited sources therein."
/>
...
<DataTable
  caption="Table 17-C — Temple Mountain district production, 1948–1956"
  note="Source: mindat.org, Temple Mountain Mining District, as cited in §17.5."
  id="table-17-c"
>

| Product | Quantity | Unit |
|---|---|---|
| U₃O₈ (uranium oxide, "yellowcake") | ~1,287,000 | pounds |
| V₂O₅ (vanadium pentoxide) | ~3,799,000 | pounds |
...
<DataTable
  caption="Table 17-E — The two generating stations"
  note="Sources: Global Energy Monitor, 'Hunter Power Plant'; Center for Land Use Interpretation; §17.7 and §17.12. Huntington Power Plant's capacity and retirement figures are reproduced within their own chapter's table — see §18.10 — rather than reconciled here."
  id="table-17-e"
>

| | Hunter Power Plant | Huntington Power Plant |
|---|---|---|
| Location | ~1,000-acre site just south of Castle Dale | 8 mi west of Huntington, at the Deer Creek–Huntington canyon junction |
| Units | 3 (a fourth canceled September 1983) | 2 |
| Rated capacity | >1,577 MW | *see §18.10* |
| Announced / begun | May 1974 / January 1976 | — |
| First power | Unit 1 June 1978; Unit 2 June 1980; Unit 3 mid-1983 | — |
| Fuel supply | ~4,000 tons/day, hauled on a purpose-built 12-mile private highway | Direct two-mile conveyor from the Deer Creek mine — among the shortest fuel-supply chains of any large U.S. coal plant |
| Naming | Originally the Emery Plant; renamed October 1978 for UP&L president E. Alan Hunter | — |
| Retirement | 2042 date reinstated April 2024 by Rocky Mountain Power / PacifiCorp | *see §18.10* |

</DataTable>

<FigureImage
  src="/images/chapters/ch17_opensource_utah_coal_production_timeline.png"
  alt="Timeline of Utah coal production milestones"
  caption="Figure 17.2. Timeline of major milestones in Utah coal production, from the first railroad-era mines through the Castle Valley boom, the Wilberg and Crandall Canyon disasters, and the ongoing energy transition reshaping the industry."
  credit="Utah Geological Survey (public domain)"
/>
...
<DataTable
  caption="Table 17-B — Wilberg and Crandall Canyon compared"
  note="Sources: Utah History Encyclopedia, 'Wilberg Mine Fire'; MSHA investigation findings as reported in §§17.8–17.9."
  id="table-17-b"
>

| | Wilberg Mine fire | Crandall Canyon Mine collapse |
|---|---|---|
| Date | 19 December 1984 | 6 August 2007 (collapse); 16 August 2007 (rescue collapse) |
| Location | ~12 mi NW of Orangeville | Far NW corner of Emery County |
| Deaths | 27 — 18 miners and 9 company officials | 9 — 6 miners, 3 rescue workers |
| Bodies recovered | Yes | No |
| Cause as found | Faulty air compressor left running unattended in a non-fireproofed area (MSHA, spring 1987) | Overly aggressive retreat mining; pillar strength overstated by a factor of two; mine "destined to fail" (MSHA) |
| Federal action | 34 citations against Utah Power and Light and Emery Mining Co.; 9 identified as contributing | $1.85 million penalty against Genwal Resources, 24 July 2008 — then the highest coal-mine safety penalty on record |
| Memorial | Eight-foot Canadian granite slab, Orangeville | County memorial; families active in national mine-safety policy |
...
<DataTable
  caption="Table 17-A — Selected mines and operations"
  note="Sources: utahrails.net, 'Emery County Coal Mines'; Utah DOGM Deer Creek file; mindat.org, San Rafael Swell and Temple Mountain district pages. The smaller 1920s–30s collieries (§17.3) carry no established opening/closing dates in the available sources."
  id="table-17-a"
>

| Operation | Commodity | Field / district | Operator(s) | Period | Note |
|---|---|---|---|---|---|
| Castle Gate No. 1 | Coal | Book Cliffs (Carbon Co.) | Pleasant Valley Coal Co. | 1886– | Set the template for every camp that followed |
| San Rafael Fuel Co. camp | Coal | Wasatch Plateau, near Emery | San Rafael Fuel Co. | 1910– | Capitalized at $1 million; first major local venture |
| Temple Mountain | Radium, then uranium–vanadium | San Rafael Swell | Various | 1898 (claims), 1914–1920s, 1948–1956 | Two separate booms; Temple City shanty town |
| Wilberg | Coal | Wasatch Plateau | Peabody; Castle Valley Mining; Emery Mining Co. | 1961 reopened–1984 | Site of the 1984 fire |
| Deer Creek | Coal | Wasatch Plateau, ~15 mi W of Huntington | PacifiCorp | 1970s–2015 | Longwall in Blind Canyon Seam; >4 M tons/yr; ~18,000 acres |
| Crandall Canyon (formerly Genwal) | Coal | NW corner of the county | Genwal Resources | –2007 | Site of the 2007 collapse |
| Lila Canyon | Coal | Book Cliffs, S of Horse Canyon | UtahAmerican Energy; Emery County Coal Resources | 2010–2024 | Fire Sept 2022; sealed 15 Jan 2024 |
| Copper Globe, Green Vein No. 5, Dolly, Dirty Devil, Little Erma, Delta, Lucky Strike | Copper (secondary) | San Rafael Swell | Small operators | ~1950s | Production in tons, not carloads; mostly short-lived |
| Latuda, Consumers, and other small Emery-area collieries | Coal | Wasatch Plateau | Various | *[needs additional sources]* | Opening and closing dates not established — see §17.3 |

</DataTable>

## 17.11 Labor, Ethnicity, and Community

Emery County's mines, like those of Carbon County next door, were built by an immigrant workforce. From the 1880s onward, the Denver and Rio Grande Western and the coal companies it controlled hired **labor agents** to recruit workers from Italy, Greece, Finland, Yugoslavia, Japan, Mexico, and elsewhere. By 1900, laborers from fourteen countries worked the camps at Winter Quarters, Castle Gate, Sunnyside, Clear Creek, and — somewhat later — the smaller Emery County collieries (Utah History To Go, "Old King Coal"; Utah Historical Quarterly vol. 74, 2006) — recruited immigrant labor that drove the demographic changes traced in <CrossRef chapter={22} />.
...
<FigureImage
  src="/images/chapters/ch17_figure_coal-production-benchmarks.svg"
  alt="Bar chart comparing Emery County coal production in 1980 against the 2020-2023 annual figures"
  caption="Figure 17-A. Coal production: the 1980 peak against 2020–2023. Only cited benchmark years are plotted; the intervening years are not shown and no trajectory between them is implied."
  credit="Source: Utah History To Go, 'Old King Coal' (1980); Utah Geological Survey Table 2.8 (2020–2023)."
/>

<DataTable
  caption="Table 17-D — Coal production benchmarks"
  note="Tabular twin of Figure 17.2. Source: Utah Geological Survey, Table 2.8, and Utah History To Go, 'Old King Coal,' as cited in §17.12."
  id="table-17-d"
>

| Year | Short tons | Source |
|---|---|---|
| 1980 (peak) | 6,320,000 | Utah History To Go, "Old King Coal" |
| 2020 | 712,681 | Utah Geological Survey, Table 2.8 |
| 2021 | 778,989 | Utah Geological Survey, Table 2.8 |
| 2022 | 762,244 | Utah Geological Survey, Table 2.8 |
| 2023 | 650,486 | Utah Geological Survey, Table 2.8 |
...
Whatever comes next — renewable energy projects, data centers, critical-minerals recovery from legacy tailings, or some combination not yet foreseen — the geologic inheritance of Emery County has already shaped more than a century of human history. The Blackhawk coals, the Chinle and Morrison uranium, and the Navajo copper made this county what it is; they will also, in their closing chapter, shape what it becomes — a transition explored fully in <CrossRef chapter={21} />.

---

## Sources

- USGS Bulletin 628, *Geology and Coal Resources of Castle Valley* — https://pubs.usgs.gov/bul/0628/report.pdf
- USGS Bulletin 1239, *Geology, Altered Rocks, and Ore Deposits of the San Rafael Swell, Emery County, Utah* — https://pubs.usgs.gov/bul/1239/report.pdf
- Utah Geological Survey, Table 2.8: Coal Production in Utah by Coal Mine, 2002–2024 — https://geology.utah.gov/docs/statistics/coal2.0/pdf/T2.8.pdf
- BLM Price Field Office, *Appendix 25 — Coal Report for Carbon and Emery Counties* — https://eplanning.blm.gov/public_projects/lup/67041/83339/99938/Appendix_25-Coal_Report_for_Carbon_and_Emery_Counties.pdf
- Utah History Encyclopedia, "Coal Mining in Utah" — https://www.uen.org/utah_history_encyclopedia/c/COAL_MINING_IN_UTAH.shtml
- Utah History Encyclopedia, "Wilberg Mine Fire" — https://www.uen.org/utah_history_encyclopedia/w/WILBERG_MINE_FIRE.shtml
- Utah History To Go, "Old King Coal — A Long, Colorful Story" — https://historytogo.utah.gov/old-king-coal/
- Utah History To Go, "Utah's Uranium Boom" — https://historytogo.utah.gov/utahs-uranium-boom/
- Utah Historical Society, "The Uranium Boom and Free Enterprise" — https://history.utah.gov/blog/the-uranium-boom-and-free-enterprise/
- Wikipedia, "Wilberg Mine" — https://en.wikipedia.org/wiki/Wilberg_Mine
- Wikipedia, "Crandall Canyon Mine" — https://en.wikipedia.org/wiki/Crandall_Canyon_Mine
- Wikipedia, "Temple Mountain (Utah)" — https://en.wikipedia.org/wiki/Temple_Mountain_(Utah)
- utahrails.net, "Emery County Coal Mines" — https://utahrails.net/utahcoal/emery-county-mines.html
- utahrails.net, "Sufco Coal Mine" — https://utahrails.net/utahcoal/sufco.php
- utahrails.net, "Lila Canyon Coal Mine" — https://utahrails.net/utahcoal/lila-canyon.html
- Utah Division of Oil, Gas & Mining, Deer Creek Mine file — https://ogm.utah.gov/coalhydro/DEERCRK.HTM
- Global Energy Monitor, "Hunter Power Plant" — https://www.gem.wiki/Hunter_Power_Plant
- Center for Land Use Interpretation, "Hunter Power Plant" — https://clui.org/ludb/site/hunter-power-plant
- mindat.org, "Temple Mountain Mining District" — https://www.mindat.org/loc-19321.html
- mindat.org, "San Rafael Swell Mining District" — https://www.mindat.org/loc-4146.html
- Deseret News, "PacifiCorp to Close Deer Creek Mine in 2015" — https://www.deseret.com/2014/12/15/20554812/pacificorp-to-close-deer-creek-mine-in-2015/
- Salt Lake Tribune, "Utah's Lila Canyon Mine Is Idled" (December 2023) — https://www.sltrib.com/news/2023/12/21/utahs-lila-canyon-mine-is-idled/
- KSL, "Looking Back at the Crandall Canyon Mine Collapse 10 Years Later" — https://www.ksl.com/article/45302392/looking-back-at-the-crandall-canyon-mine-collapse-10-years-later
- Utah Foundation, Report 745 (April 2017), *Utah's Coal Counties* — https://www.utahfoundation.org/wp-content/uploads/rr745.pdf
- Legends of America, "Castle Gate, Utah — Coal Mining Queen" — https://www.legendsofamerica.com/castle-gate-utah/
...
*Research file:* `research/Ch17_research_notes.md`
*Chapter folder:* `Part_III_Exploration_Settlement/Ch17_Coal_Copper_Uranium/`

---

## Further Reading

- [MSHA — Crandall Canyon Mine](https://arlweb.msha.gov/genwal/crandallcanyon.asp)
- [Utah Geological Survey, Table 2.8 — Coal Production in Utah by Coal Mine, 2002–2024](https://geology.utah.gov/docs/statistics/coal2.0/pdf/T2.8.pdf)
- [Utah Geological Survey — Utah Energy & Mineral Statistics](https://geology.utah.gov/energy-minerals/info/energy-mineral-statistics/)
- [USGS Bulletin 1239 — Geology, Altered Rocks, and Ore Deposits of the San Rafael Swell](https://pubs.usgs.gov/bul/1239/report.pdf)
- [Utah History Encyclopedia — Wilberg Mine Fire](https://www.uen.org/utah_history_encyclopedia/w/WILBERG_MINE_FIRE.shtml)
