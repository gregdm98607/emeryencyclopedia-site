...
This chapter is a practical companion to the activity chapters of Part V. Chapters 30 through 35 describe what there is to do in Emery County (see <CrossRef chapter={30} />); this chapter describes how to actually get there, where to stay, where to ask for help, and how to leave the country in better shape than you found it. The county's recreational riches — the San Rafael Swell, Goblin Valley State Park, the Wasatch Plateau high country, the Green River corridor — sit largely outside the day-to-day reach of services. Even Castle Dale, the county seat, has only one or two fuel stations and a single grocery store. Once you turn off the paved highway, you are responsible for yourself. The reward is solitude on a scale the more famous Utah destinations cannot match. The price is a kind of careful self-sufficiency.
...
**Interstate 70** enters the county from the east at Exit 158 (Green River business loop) and exits to the west near Exit 129 (the I-70/US-6 junction with Carbon County). Within the county, the interstate climbs through Spotted Wolf Canyon — engineered in the late 1960s, opened in stages between 1970 and 1990, and completed in 1990 as one of the final sections of the original Interstate Highway System (Glenwood Canyon in Colorado followed in 1992) (see <CrossRef chapter={18} />) — and rises onto the western plateau by way of the San Rafael Reef cut. The exits between Green River and the western county line are gateways rather than service stops. Exit 131 takes drivers into Green River proper; Exit 147 leads north up Black Dragon Wash toward Buckhorn Draw; Exit 149 (Sinkhole / Behind the Reef) gives 4×4 access into the Swell interior; Exit 160 (SR-24) leaves the interstate toward Hanksville and Capitol Reef; Exit 164 reaches Temple Mountain Road and the southern Swell; Exit 175 (Ranch Exit) opens onto Justensen Flats and the Reds Canyon loop. Drivers should not rely on any of these exits for fuel, water, or cellular signal.
...
<DataTable
  caption="Table 36-A — Gateways and Base Camps"
  note="Populations: U.S. Census Bureau, 2020 Decennial Census (exact counts per Ch36 fact-check). Fuel and base-camp characterizations: §36.3, §36.6."
  id="table-36-a"
>

| Community | Population (2020 Census) | Fuel | Best base for |
|---|---|---|---|
| Green River | 902 | Multiple stations | River floats, eastern Swell, chain lodging |
| Price (Carbon Co.) | 8,317 | Full inventory | Northern approach, hospital, supply runs |
| Castle Dale (county seat) | 1,492 | 1–2 stations | The Wedge, Buckhorn Wash, Cleveland-Lloyd |
| Hanksville (Wayne Co.) | 219 | Limited | Southern approach, Goblin Valley |
| Huntington | 2,131 | 2 stations | SR-31, northern Wasatch Plateau |
| Ferron | 1,648 | 1 station | Millsite SP, Ferron Canyon |
| Orangeville | 1,470 | — | SR-29, Joe's Valley |
| Emery | ~285 | Intermittent | Southern SR-10 corridor |
...
<DataTable
  caption="Table 36-B — Campground Directory"
  note="Camping infrastructure described in §36.5. Em-dashes mark values the chapter does not state — no counts estimated. Verify site counts and current fees against agency pages before print."
  id="table-36-b"
>

| Campground | Agency | Sites | Water | Amenities | Fee / Reservations |
|---|---|---|---|---|---|
| Green River SP | Utah State Parks | 40+ | Yes | Hookups, showers, river access | Fee; reserveamerica.com |
| Millsite SP | Utah State Parks | ~30 | Yes | Below reservoir dam; angling | Fee; reserveamerica.com |
| Goblin Valley SP | Utah State Parks | Developed sites + 2 yurts | Yes | Beneath hoodoo field | Fee; reservations essential |
| San Rafael Bridge | BLM | ~20 primitive | No | Vault toilets, fire rings, horse corrals | Per-night, iron ranger |
| Wedge Overlook | BLM | Dispersed pullouts | No | Vault toilet at viewpoint | Free; first-come |
| Temple Mountain | BLM | Primitive | No | Convenient to Goblin Valley | — |
| Joe's Valley | USFS | — | — | On reservoir; seasonal (≈mid-Oct close) | Fee; some recreation.gov |
| Indian Creek | USFS | — | — | Above Joe's Valley; seasonal | Fee |
| Forks of Huntington | USFS | — | — | Huntington Canyon; seasonal | Fee |
| Old Folks Flat | USFS | — | — | Huntington Canyon; seasonal | Fee |
...
**State parks** all charge day-use vehicle fees: Goblin Valley State Park ($20 per vehicle as of the most recent fee schedule), Green River State Park ($10), and Millsite State Park ($10) (see <CrossRef chapter={31} />). Camping requires advance reservation through the Utah State Parks reservation system at utahstateparks.reserveamerica.com. Goblin Valley's two yurts and most of its developed campsites book three to six months ahead during peak windows.
...
<DataTable
  caption="Table 36-C — Permits and Fees"
  note="Permits and fees per §36.9. The Desolation Canyon cap carries the chapter's own [needs verification] flag — not resolved here."
  id="table-36-c"
>

| Site / activity | Requirement | Fee | Notes |
|---|---|---|---|
| Goblin Valley SP | Day-use | $20/vehicle | Per most recent fee schedule; resident/non-resident tiers may vary (fact-check flag) |
| Green River SP | Day-use | $10/vehicle | |
| Millsite SP | Day-use | $10/vehicle | |
| Jurassic National Monument (Cleveland-Lloyd) | Day-use, seasonal ≈Mar–Oct | Per-vehicle | Federal interagency passes honored |
| Desolation Canyon float | BLM lottery launch permit | — | Lottery opens Dec 1, closes Jan 31; user-day cap [needs verification: 2025/2026 BLM RMP] |
| Labyrinth Canyon float | Mandatory advance permit | Free | recreation.gov; Moab FO co-administers lower section |
| San Rafael Bridge CG | Per-night camping | Iron ranger | SRSRA has no general entrance fee |
| USFS campgrounds | Per-night camping | At campground | Several reservable via recreation.gov |
...
<DataTable
  caption="Table 36-D — Emergency and Information Contacts"
  note="Quick-reference contacts from §36.8 and §36.10. Fact-check status: drawn from agency pages, not spot-verified this pass — verify all numbers before publication (standing Phase-8 action item)."
  id="table-36-d"
>
...
|---|---|
| Emergency | 9-1-1 |
| Emery County Sheriff dispatch (24 hr, non-emergency) | (435) 381-2404 |
| Emery County Travel Bureau | (435) 381-2600 · (888) 564-3600 · 75 E Main, Castle Dale |
| BLM Price Field Office | (435) 636-3600 · 125 S 600 W, Price |
| USFS Ferron–Price Ranger District | (435) 637-2817 · 599 W Price River Dr, Price |
| Road conditions | UDOT 511 / udottraffic.utah.gov |
...
<FigureImage
  src="/images/chapters/ch36_figure_activity-calendar.png"
  alt="Horizontal calendar chart showing seven Emery County activities and their optimal months, with a shaded monsoon-warning band from mid-July to early September"
  caption="Figure 36-A. The Emery County activity year. Optimal windows for the principal Part V activities — canyoneering, rafting, Joe's Valley bouldering, Skyline mountain biking, Arapeen OHV, wildlife watching, and dark-sky viewing — as described in §36.11."
  credit="Original chart for this work; data per Chapter 36 text and agency seasonal information cited therein."
/>
...
- [UDOT — Traffic and Road Conditions](https://www.udottraffic.utah.gov) — real-time I-70/SR-10 road status, closures, and the 511 traveler information line.
- [Utah State Parks — Reservations](https://stateparks.utah.gov/reservations/) — camping and yurt reservations for Green River, Millsite, and Goblin Valley state parks.
- [Recreation.gov](https://www.recreation.gov) — USFS campground reservations and the Labyrinth/Desolation Canyon river permit system.
- [BLM — San Rafael Swell Recreation Area](https://www.blm.gov/visit/san-rafael-swell-recreation-area) — travel management plan, road conditions, and dispersed-camping rules.
- [The Swell (Emery County Travel Bureau)](https://www.theswellutah.com) — lodging, outfitter, and current-conditions directory.
- [USDA Forest Service — Manti-La Sal National Forest](https://www.fs.usda.gov/main/mantilasal/home) — Ferron-Price Ranger District campgrounds and Skyline Drive access.
