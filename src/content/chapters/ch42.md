...
<figure>
  <img src="/images/chapters/ch42_opensource_geologic_timescale.gif" alt="Geologic time scale showing eons, eras, periods, and epochs" style="max-width:100%;height:auto;" />
  <figcaption><strong>Figure 42.1.</strong> The geologic time scale — the fundamental framework for understanding deep time in Emery County's rock record. Formations discussed throughout the encyclopedia span from Pennsylvanian (323 Ma) through Quaternary (present). <em>Source: U.S. Geological Survey (public domain).</em> Download full-resolution versions: <a href="/images/chapters/ch42_opensource_geologic_timescale_fs.pdf">full-size PDF</a> · <a href="/images/chapters/ch42_opensource_geologic_timescale.pdf">compact PDF</a>.</figcaption>
</figure>
