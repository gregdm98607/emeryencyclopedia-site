...
The relationship between the statewide UGRC parcels layer and the county's own plat record is best understood as one of generalization. The UGRC layer is sufficient for spatial analysis at the statewide or county scale; the County Recorder's plat is the authoritative source for legal boundary, easement, road dedication, and subdivision detail. Cross-reference Ch37 (Archives, Museums & Libraries) for the broader context of the county courthouse complex as a documentary repository (see <CrossRef chapter={37} />), and Ch38 (Historic Registries) for the cluster of registered buildings around the courthouse itself (see <CrossRef chapter={38} />).
...
The **National Park Service** does not directly manage land within Emery County's boundary, but the county is shaped by adjacent NPS units (Capitol Reef NP to the south, Glen Canyon NRA to the far southeast) and by the Old Spanish National Historic Trail, designated in 2002 and jointly managed by NPS and BLM. (See Ch38 §38.10; <CrossRef chapter={38} />.) The NPS open data portal is at https://public-nps.opendata.arcgis.com/.
...
Cross-reference Ch37 (Archives, Museums & Libraries) for the holdings of BYU L. Tom Perry Special Collections, USU Eastern, and the Utah State Archives, all of which include historic-map material relevant to Emery County (see <CrossRef chapter={37} />).
...
- USGS National Map Downloader: [apps.nationalmap.gov/downloader](https://apps.nationalmap.gov/downloader/) — single entry point for free federal topographic, elevation, hydrography, and aerial imagery data.
- USGS topoView: [ngmdb.usgs.gov/topoview](https://ngmdb.usgs.gov/topoview/) — every historic USGS topographic quadrangle published for Emery County, 1884–2006, free as georeferenced PDF.
- UGRC Open Data Portal: [opendata.gis.utah.gov](https://opendata.gis.utah.gov/) — Utah's statewide GIS data catalog (SGID), including Emery County parcels, land ownership, and geologic layers.
- Emery County Recorder — Plat Map Portal: [emerycounty.com/home/offices/recorder/plat-map](https://emerycounty.com/home/offices/recorder/plat-map/) — the authoritative source for legal parcel boundaries in the county.
- Utah Geological Survey — Geologic Map Portal: [geology.utah.gov/portfolio-item/geologic-map-portal](https://geology.utah.gov/portfolio-item/geologic-map-portal/) — statewide geologic maps, including the San Rafael Desert 30'×60' quadrangle (Map 267).
- BLM Utah GIS Data Library: [blm.gov/services/geospatial/GISData/utah](https://www.blm.gov/services/geospatial/GISData/utah) — surface management, Travel Management Area, and mineral-lease data for the county's federal lands.
- David Rumsey Map Collection: [davidrumsey.com](https://www.davidrumsey.com/) — more than 150,000 historic maps, including nineteenth-century cartography of the Green and Colorado rivers.
- OpenStreetMap US — Utah Trails Stewardship Initiative: [openstreetmap.us/our-work/trails](https://openstreetmap.us/our-work/trails/) — the community effort coordinating responsible trail mapping on Utah's public lands.
- QGIS: [qgis.org](https://qgis.org/) — free, open-source desktop GIS software; the accessible entry point into the workflow described in §39.12.
