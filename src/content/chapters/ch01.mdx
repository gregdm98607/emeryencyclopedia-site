...
<FigureImage
  src="/images/chapters/ch01_emery_county_locator_map.png"
  alt="Locator map of Emery County, Utah, showing the county outlined within the state, its county seat Castle Dale, principal settlements, and the five neighboring counties."
  caption="Figure 1.2. Emery County occupies east-central Utah, bordered by Carbon County to the north, Grand to the east, Wayne to the south, and Sevier and Sanpete to the west. The county seat, Castle Dale (★), lies among a cluster of settlements in the western valleys, while Green River anchors the eastern lowlands along the Green River corridor."
  credit="Map: Encyclopedia of Emery County. Boundaries from U.S. Census Bureau Cartographic Boundary Files, 2022 (public domain)."
/>
...
USGS (U.S. Geological Survey). (2020). *National Elevation Dataset (NED) / 3D Elevation Program (3DEP)*. 1/3 arc-second (~10-meter) seamless national layer; 1-meter lidar-derived data available where qualifying lidar surveys have been flown. Retrieved from https://www.usgs.gov/3dep/
