...
<FigureImage
  src="/images/chapters/ch01_opensource_san_rafael_reef_iss_nasa.jpg"
  alt="Oblique aerial photograph of the San Rafael Reef from the International Space Station, showing a continuous tilted hogback ridge fronting dissected desert canyons"
  caption="Figure 1.1. The San Rafael Reef photographed from the International Space Station, the rising sun raking across its tilted strata. This oblique view reveals the eastern flank of the San Rafael Swell as a continuous hogback ridge—the upturned edge of a broad anticlinal uplift—fronting deeply dissected desert canyon country."
  credit="NASA / Scott Kelly, ISS Expedition 43 (public domain)"
/>
...
<PhotoAssignment
  ...
  lookFor="Each distinct color band is a different geological formation — a different age, a different ancient world. Red-orange layers are often Wingate Sandstone (Late Triassic to Early Jurassic). Cream or buff tones may be Navajo or Entrada Sandstone. Dark grey-green bands are typically marine shale."
...
<DataTable
  caption="Table 1-A — Emery County: Elevation and Extent at a Glance"
  note="Sources: Utah Automated Geographic Reference Center (2024); USGS National Elevation Dataset / 3DEP (2020); Doelling, Geologic Map of Emery County (2004)."
  id="table-1-a"
>

| Measure | Value | Source |
|---|---|---|
| Total area | 4,472 sq mi (11,582 km²) | UAGRC County Boundary Data, 2024 |
| Highest point | East Mountain, 10,743 ft (Wasatch Plateau) | USGS NED / 3DEP |
| Lowest point | ~4,100 ft, Green River corridor (southeastern margin) | USGS NED / 3DEP |
| Total relief | ~6,643 ft | Derived (highest − lowest) |
| Principal province | Colorado Plateau; western margin in the Wasatch Plateau / High Plateaus transition | Doelling, 2004 |

</DataTable>

## 1.4 Drainage Basins & Watersheds

Emery County's surface water is organized into several major drainage basins, each with its own hydrologic characteristics (see <CrossRef chapter={3} />).
...
The lowest tier, below 5,000 feet, includes the Green River valley, much of the lowland basins surrounding settlements, and the deeply incised canyons of the major rivers. This zone is arid, receiving less than 10 inches of annual precipitation in most areas, and is dominated by salt desert shrub, Fremont cottonwood riparian woodland, and four-wing saltbush scrub. This tier comprises roughly 50–60 percent of the county's area, reflecting the reality that much of Emery County is low desert (Utah Climate Center; National Elevation Dataset) (see <CrossRef chapter={5} />).
...
<FigureImage
  src="/images/chapters/ch01_opensource_san_rafael_reef_i70_blm.jpg"
  alt="Steeply tilted sandstone strata of the San Rafael Reef rising above Interstate 70, with the highway visible at the base for scale"
  caption="Figure 1.2. The steeply tilted strata of the San Rafael Reef rise directly above Interstate 70. The reef is the upturned eastern edge of the San Rafael Swell anticline; the dipping beds of resistant sandstone, exposed by erosion, form the classic hogback that gives the 'reef' its name."
...
The San Rafael Swell occupies roughly the central third of Emery County and is one of Utah's most distinctive and scenic geomorphic features (see <CrossRef chapter={30} />). The Swell's geology—a large anticlinal fold—drives its geomorphology: as rock layers are folded upward and then eroded, the landscape becomes a complex assemblage of ridges, cliffs, and deeply incised drainages that create a maze-like topography (Doelling, 2004).
...
<FigureImage
  src="/images/chapters/ch01_opensource_wedge_overlook_panorama.jpg"
  alt="Ultra-wide panorama of the Little Grand Canyon of the San Rafael River seen from the Wedge Overlook, showing a deep gorge incised through layered desert rock"
  caption="Figure 1.3. The Little Grand Canyon of the San Rafael River, seen from the Wedge Overlook. The river has incised more than 1,000 feet through the heart of the San Rafael Swell, exposing the folded sedimentary layers of the anticline in a single vertical slice."
...
- [Utah Geological Survey — Geology Portal](https://geology.utah.gov/) — State geologic mapping, hazards data, and publications covering the San Rafael Swell and Wasatch Plateau.
- [USGS 3D Elevation Program (3DEP)](https://www.usgs.gov/3dep/) — National seamless elevation data and lidar-derived digital elevation models used for terrain and hypsometric analysis.
- [Utah Automated Geographic Reference Center (UGRC)](https://gis.utah.gov/) — Statewide GIS clearinghouse for county boundaries and reference datasets.
- [USDA NRCS Web Soil Survey](https://websoilsurvey.nrcs.usda.gov/) — Interactive soil survey data for Emery County soil orders and series.
