...
<FigureImage
  src="/images/chapters/ch29_figure_capacity-chronology.svg"
  alt="Multi-tier chronology chart of institutional capacity and major emergency events in Emery County from 1877 to 2026, with capacity milestones drawn across four tiers and emergency events marked along a shared time axis"
  caption="Figure 29-A. Institutional capacity and major emergency events in Emery County, 1877–2026. Event entries carry no casualty figures; see Table 29-A."
  credit="Sources: as cited in the text of this chapter."
/>
...
<DataTable
  caption="Table 29-C — Emergency service coverage by community"
  note="Every incorporated community fields a volunteer fire department; five of the eight also stage an ambulance. Paramedic-level care arrives via Castleview Hospital's transport team or AirMed helicopter; mutual aid for the southern and southwestern county comes from Richfield, in Sevier County. No staffed station of any kind lies within the San Rafael Swell. Sources: §29.9 and §29.10, from Emery County service-district and emergency-management pages, emery.utah.gov."
  id="table-29-c"
>

| Community | Volunteer fire department | Ambulance staging |
|---|---|---|
| Castle Dale | Yes | Yes |
| Cleveland | Yes | — |
| Elmo | Yes | — |
...
The special-service-district structure is itself worth understanding. Created under Utah law and funded primarily through a portion of the county property tax plus state and federal grants, special service districts carry independent boards, budgets, and contracting authority. They allow Emery County to provide professional-grade fire and EMS services without the overhead of integrating those services into the general county budget. The same structure underpins water and irrigation governance and is one of the county's quieter administrative innovations (see <CrossRef chapter={23} />).

<DataTable
  caption="Table 29-B — Emery County special service districts"
  note="Districts are funded primarily through a portion of the county property tax plus state and federal grants, and carry independent boards, budgets and contracting authority. Boundaries are not published in the sources consulted. Source: Emery County service-district pages, emery.utah.gov; Utah Public Notice Manager."
  id="table-29-b"
>

| District | Service | Headquarters / contact | Notes |
|---|---|---|---|
| Emery County Special Service District #1 | Emergency management and EMS | Ambulance dispatch 435-381-3570 | Operates the county EMS system |
| Emery Emergency Medical Special Service District (EEMSSD) | EMS governance | Board meets at the County Administration Building, 75 East Main, Castle Dale | Listed in the Utah Public Notice Manager |
| Fire Protection Special Service District | Wildland and structural fire coordination | County-wide | Coordinates the eight community volunteer departments |
| Castle Valley Special Service District | Fire and other emergency functions | Castle Valley corridor | Additional service-district authority alongside the Fire Protection SSD |

</DataTable>

## 29.11 Mining disasters as medical and rescue events: Wilberg (1984) and Crandall Canyon (2007)

No two events have shaped the practice of emergency response in Emery County more than the Wilberg Mine fire of 19 December 1984 and the Crandall Canyon Mine collapse of 6 August 2007. Both are described in their full industrial and human dimensions in <CrossRef chapter={17} />; their treatment here focuses on medical and rescue response.
...
<DataTable
  caption="Table 29-A — Major emergency events, 1918–2020"
  note="No individual is named in this table. Sources: as cited in §29.2, §29.8, §29.11 and §29.12. Mining-incident detail is carried in Ch17 and Ch28 (Table 28-C)."
  id="table-29-a"
>

| Date | Event | Principal responding agencies | Recorded fatalities |
|---|---|---|---|
| Oct 1918 | Influenza pandemic reaches Castle Valley; statewide ban on public gatherings | Utah State Health Officer; LDS ward bishops and Relief Society presidents as auxiliary nurses and contact tracers | County-level count not established (see §29.2) |
| 2 June 1983 | Statewide spring runoff flooding; Emery among eleven counties declared disaster areas | State of Utah; FEMA following federal declaration; local irrigation companies | Not recorded in county sources |
| 19 Dec 1984 | Wilberg Mine fire | ECSO; ECSAR; Carbon and Emery fire crews; MSHA mine-rescue teams; State Fire Marshal; Castleview Hospital; statewide behavioural-health crisis support | 27 |
| 6 and 16 Aug 2007 | Crandall Canyon Mine collapse, and second collapse during rescue | MSHA; ECSO incident command; ECSAR | 6 miners; 3 rescuers |
| 6–15 June 2018 | Trail Mountain Fire (9,554 acres at 10% containment mid-June) | USFS Type 2 incident-management team; Manti-La Sal National Forest; county volunteer fire departments; UDOT (SR-31 closure) | None reported |
| 11 May 2020 | Little Wildhorse Canyon flash flood, near Goblin Valley State Park | ECSO multi-agency recovery; ECSAR | 2 (21 other hikers self-rescued) |

</DataTable>

## Further Reading & Links

- [Emery County Sheriff's Office](https://emerycounty.com/home/offices/sheriff/) — Patrol, corrections, and emergency-management coordination for the county's 4,500 square miles.
- [Emery County Search and Rescue](https://emerycounty.com/home/offices/sheriff/sar/) — Volunteer roster, training requirements, and callout information.
- [Emery County service districts](https://emery.utah.gov/home/service-districts/) — The fire, EMS, and Castle Valley special service districts described in §29.9–§29.10.
- [Emery County Pre-Disaster Mitigation Plan](https://emeryhazardplan.org) — The county's multi-hazard planning document, updated on a multi-year FEMA Region VIII cycle.
- [Castleview Hospital, Price](https://castleviewhospital.net) — The regional acute-care hub and Level IV Trauma Center serving Carbon and Emery counties.
- [Four Corners Community Behavioral Health](https://fourcornersbh.com) — Outpatient, crisis, and Opioid Treatment Program services across Carbon, Emery, and Grand counties.
- [*Utah History Encyclopedia*, "Wilberg Mine Fire"](https://www.uen.org/utah_history_encyclopedia/w/WILBERG_MINE_FIRE.shtml) — The standard reference account of the December 1984 fire.
- [U.S. Department of Labor / MSHA news release, 27 September 2012](https://www.dol.gov/newsroom/releases/msha/msha20120927) — The Genwal/Andalex civil settlement.
- [Utah Investigative Journalism Project — "Utah's rehab deserts"](https://utahinvestigative.org) — The reporting behind §29.6's treatment-capacity findings.
